package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1362:String = "asset-libraries";
      
      private static const const_1370:String = "library";
      
      private static const const_1366:String = "service-libraries";
      
      private static const const_1367:String = "library";
      
      private static const const_1365:String = "component-libraries";
      
      private static const const_1368:String = "library";
      
      private static const const_1364:String = "error_data";
      
      private static const const_1363:String = "error_cat";
      
      private static const const_1369:String = "error_desc";
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1039:
               debug("Core; using simple frame update handler");
               this.var_352 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_767:
               debug("Core; using complex frame update handler");
               this.var_352 = this.complexFrameUpdateHandler;
               break;
            case Core.const_834:
               debug("Core; using profiler frame update handler");
               this.var_352 = this.profilerFrameUpdateHandler;
               this.var_199 = new Profiler(this);
               attachComponent(this.var_199,[new IIDProfiler()]);
               var_398.addChild(new ProfilerViewer(this.var_199));
               break;
            case Core.const_529:
               debug("Core; using experimental frame update handler");
               this.var_352 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_352 = this.debugFrameUpdateHandler;
         }
      }
      ...
      {
         return this.var_508 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            try
            {
               ...
               {
                  receivers = this.var_253[i] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1364,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1363,String(param3));
         ErrorReportStorage.setParameter(const_1369,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         try
         {
            node = config.child(const_1366)[0];
            if(node != null)
            {
               list = node.child(const_1367);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1556);
         if(!disposed)
         {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_765)
                  {
                     this.var_765.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_508 - this.var_353.length,this.var_508,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_199 ? 0 : this.var_1442 & 0;
         if(_loc3_ == Core.const_529)
         {
            this.var_253[param2].push(new UpdateDelegate(param1,this,param2));
         }
         else
         {
            this.var_253[param2].push(param1);
         }
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_199 ? 0 : this.var_1442 & 0;
         var _loc5_:int = 0;
         while(_loc5_ < CoreComponentContext.const_103)
         {
            _loc3_ = this.var_253[_loc5_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_352(_loc2_,_loc2_ - this._lastUpdateTimeMs);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_611[priority] = 0;
            receivers = this.var_253[priority];
            index = 0;
            length = receivers.length;
            while(index != length)
            {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_103)
         {
            ...
            {
               if(this.var_611[priority] < priority)
               {
                  ++this.var_611[priority];
                  skip = true;
               }
            }
            if(!skip)
