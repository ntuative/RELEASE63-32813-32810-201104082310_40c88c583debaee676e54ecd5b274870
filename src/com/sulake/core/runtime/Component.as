package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_2026:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1052:uint = 4;
       
      
      protected var var_752:uint = 0;
      
      protected var var_1306:String = "";
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1306 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1306);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1442 & const_1052)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_752 + "]";
      }
