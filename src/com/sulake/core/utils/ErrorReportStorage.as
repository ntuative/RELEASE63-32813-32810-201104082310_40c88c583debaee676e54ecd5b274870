package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1113:Map = new Map();
      
      private static var var_726:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_726.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_726.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_726.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
