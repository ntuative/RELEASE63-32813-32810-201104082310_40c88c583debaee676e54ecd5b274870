package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1758:uint = 4;
      ...
      public static const const_1230:Boolean = false;
      
      public static const const_1561:int = 2;
      
      private static var var_1023:Array = new Array();
      
      private static var var_824:Array = new Array();
      ...
      protected var var_2954:uint = 0;
      
      protected var var_2878:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1230)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_824[_loc2_] as LibraryLoader;
            ...
            while(var_824.length < const_1561 && false)
            {
               _loc1_ = var_1023.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1067 ? uint(this.var_1320 - this.var_2101) : uint(getTimer() - this.var_2101);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,this.var_399,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
            try
            {
               this.var_42.close();
            }
      ...
      {
         if(this.var_1066 && !_disposed)
         {
            this.var_1066 = false;
            if(!this.var_1067 && this.var_239)
            {
               this.var_1320 = -1;
               this.var_2101 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1067 && !_disposed && this.var_1321 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_239,const_1464 - this.var_1321);
            if(this.var_2878)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HTTPStatusEvent.HTTP_STATUS:
               ...
               this.debug("Load event STATUS " + this.var_399 + " for file \"" + this.url + "\"");
               break;
            case Event.UNLOAD:
               this.debug("Load event UNLOAD for file \"" + this.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,this.var_399,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case ProgressEvent.PROGRESS:
               this.debug("Load event PROGRESS for file \"" + this.url + "\"  bytes: " + this.bytesLoaded + "/" + this.bytesTotal);
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,this.var_399,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
               break;
            case IOErrorEvent.IO_ERROR:
               this.debug("Load event IO ERROR for file \"" + this.url + "\"");
               if(!this.handleHttpStatus(this.var_399))
               {
         ...
         if(this.var_469 == LibraryLoader.const_1760)
         {
         ...
         if(this.var_469 == LibraryLoader.name_4)
         {
            if(this.prepareLibrary())
            {
               ...
               this.removeEventListeners();
               throttle();
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.var_399,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_651 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_651.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(this._debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,this.var_399,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         }
      }
      ...
      protected function failure(param1:String) : void
      {
         ...
         throttle();
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.var_399,this.bytesTotal,this.bytesLoaded,this.elapsedTime));
         dispatchEvent(new Event(LIBRARY_LOADER_FINALIZE));
      }
