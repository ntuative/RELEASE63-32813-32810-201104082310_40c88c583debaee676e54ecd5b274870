package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1256:String = "AssetLibraryReady";
      
      public static const const_894:String = "AssetLibraryLoaded";
      
      public static const const_1718:String = "AssetLibraryUnloaded";
      
      public static const const_1628:String = "AssetLibraryLoadError";
      
      private static const const_438:String = "name";
      
      private static const const_1014:String = "asset";
      
      private static const const_1013:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1015:String = "library";
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_1016 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_652 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1015);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1014);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_438);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1013);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_652 + "!");
               }
               _loc15_++;
            }
         }
      ...
      {
         if(this.var_652 == param1.url && this.var_1013)
         {
            if(!this.var_1014 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_651);
            }
            this.var_1014 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1256));
         }
         else
         {
      ...
      {
         var _loc2_:Class = this.var_1016[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1236,this.assetLoadEventHandler);
      ...
      {
         return this.var_167[param1] != null || (this.var_651 != null ? this.var_651[param1] != null : false);
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_651 = _loc2_.resource;
         this.var_652 = _loc2_.url;
         if(this.var_1014)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_651);
         }
         this.var_1013 = true;
         dispatchEvent(new Event(AssetLibrary.const_894));
         dispatchEvent(new Event(AssetLibrary.const_1256));
         if(this.var_1014)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1628));
         this.var_42 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1015);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1014);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_438).toString() == param1)
               {
                  _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                  if(_loc4_ == null)
                  {
                     throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_652 + "!");
                  }
                  _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                  _loc5_.setUnknownContent(this.var_651[param1]);
                  _loc6_ = _loc3_.child(const_1013);
                  if(_loc6_.length())
                  {
