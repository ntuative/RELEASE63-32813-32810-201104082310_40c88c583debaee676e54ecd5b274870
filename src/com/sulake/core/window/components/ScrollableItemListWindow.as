package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_423:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_423)
         {
            this.var_423.removeEventListener(WindowEvent.const_267,this.scrollBarEventProc);
            this.var_423.removeEventListener(WindowEvent.const_206,this.scrollBarEventProc);
            this.var_423 = null;
         }
         if(this.var_1168)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1168)
         {
            this.var_1168 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_423)
         {
            this.var_423 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_423)
            {
               this.var_423.addEventListener(WindowEvent.const_267,this.scrollBarEventProc);
               this.var_423.addEventListener(WindowEvent.const_206,this.scrollBarEventProc);
            }
         }
         return this.var_423;
      }
