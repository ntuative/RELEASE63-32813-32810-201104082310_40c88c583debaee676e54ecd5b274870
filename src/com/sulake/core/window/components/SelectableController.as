package com.sulake.core.window.components
{
   ...
   public class SelectableController extends InteractiveController implements ISelectableWindow
   {
            ...
            if(_parent)
            {
               if(!(_parent is ISelectorWindow))
               {
                  ...
                  while(_loc3_)
                  {
                     ...
                     {
                        _loc4_ = WindowEvent.allocate(WindowEvent.const_319,this,null);
      ...
      public function select() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_56,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         activate();
         return true;
      ...
      public function unselect() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_475,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
