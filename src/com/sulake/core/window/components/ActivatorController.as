package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_319)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1196)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_861;
         if(this.var_861 != param1)
         {
            if(this.var_861 != null)
            {
               if(!this.var_861.disposed)
               {
                  this.var_861.deactivate();
               }
            }
            this.var_861 = param1;
