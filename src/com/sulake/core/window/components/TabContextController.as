package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1359:String = "_SELECTOR";
      
      private static const const_1358:String = "_CONTENT";
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1060 = findChildByTag(const_1359) as ITabSelectorWindow;
            if(this.var_1060 != null)
            {
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2092 = findChildByTag(const_1358) as IWindowContainer;
         }
      ...
      {
         return !!this.var_852 ? this.selector.iterator : null;
      }
