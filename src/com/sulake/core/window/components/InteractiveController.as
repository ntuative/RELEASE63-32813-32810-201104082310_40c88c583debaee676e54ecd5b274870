package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_562)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_562)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_715,param1.toolTipCaption,PropertyStruct.const_55,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1501);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1198)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_705,param1.toolTipDelay,PropertyStruct.const_238,true));
         }
         else
         {
