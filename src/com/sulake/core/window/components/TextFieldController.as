package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_852:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1185,var_11);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_852 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_382,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_413,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_837,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1642);
         _loc1_.push(this.var_1309 != PropertyDefaults.const_1069 ? new PropertyStruct(PropertyDefaults.const_790,this.var_1309,PropertyStruct.const_38,true) : PropertyDefaults.const_1601);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1158 ? new PropertyStruct(PropertyDefaults.const_827,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1477);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1250 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1682);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_837:
                  ...
                  break;
               case PropertyDefaults.const_1044:
