package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1264:Dictionary = createPropertySetterTable();
      ...
      protected var var_1062:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_441,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_441 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_441,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_192);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_804 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_867 * this.maxScrollH,this.var_564 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1240) ? new PropertyStruct(PropertyDefaults.const_698,this._field.antiAliasType,PropertyStruct.const_55,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1151) : PropertyDefaults.const_1574);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1257 ? new PropertyStruct(PropertyDefaults.const_816,this._autoSize,PropertyStruct.const_55,true,PropertyDefaults.const_1186) : PropertyDefaults.const_1696);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1153 ? new PropertyStruct(PropertyDefaults.const_1179,this._field.gridFitType,PropertyStruct.const_55,true,PropertyDefaults.const_1036) : PropertyDefaults.const_1728);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_879) ? new PropertyStruct(PropertyDefaults.const_426,this._field.textColor,PropertyStruct.const_152,true) : PropertyDefaults.const_1101);
         ...
         _loc1_.push(this.var_40.left != PropertyDefaults.const_819 ? new PropertyStruct(PropertyDefaults.const_245,this.var_40.left,PropertyStruct.const_42,true) : PropertyDefaults.const_460);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_700 ? new PropertyStruct(PropertyDefaults.const_250,this.var_40.top,PropertyStruct.const_42,true) : PropertyDefaults.const_595);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_680 ? new PropertyStruct(PropertyDefaults.const_237,this.var_40.right,PropertyStruct.const_42,true) : PropertyDefaults.const_490);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_924 ? new PropertyStruct(PropertyDefaults.const_272,this.var_40.bottom,PropertyStruct.const_42,true) : PropertyDefaults.const_525);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1138 ? new PropertyStruct(PropertyDefaults.const_725,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1720);
