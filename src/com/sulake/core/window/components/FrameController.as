package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1413:String = "_TITLE";
      
      private static const const_1411:String = "_HEADER";
      
      private static const const_1410:String = "_CONTENT";
      
      private static const const_1412:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1522:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1413) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1522 = findChildByTag(const_1411) as IHeaderWindow;
            if(!this.var_1522)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_187 = findChildByTag(const_1410) as IWindowContainer;
            if(!this.var_187)
            {
      ...
      {
         return findChildByTag(const_1412) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1266,_loc2_,false);
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_245,_loc3_.left,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_250,_loc3_.top,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_272,0 - _loc3_.bottom,PropertyStruct.const_42,_loc2_));
         }
         else
         {
