package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private var var_1061:Matrix;
      
      private var var_751:ColorTransform;
      
      private var var_1425:uint;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1425 = 4294967295;
         this.var_930 = 0;
         this.var_751 = new ColorTransform();
         this.var_1061 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_930))
            {
               _loc5_ = const_982;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_982)
               {
                  ...
                  if(this.var_601)
                  {
                     ...
                     _loc7_.draw(param1,this.var_112,this.var_112.rect,this.var_930,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1061.tx = param2.x;
                     this.var_1061.ty = param2.y;
                     this.var_751.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_112,this.var_1061,this.var_751,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = this.var_878.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_202)
            {
               _loc2_ = this.var_878.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_202);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_878.getTheActualState(param1.type,param1.style,param1.state) != this.var_1425;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_1143:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  _loc4_ = true;
               }
               ...
               break;
            case WindowRedrawFlag.const_799:
               this.var_930 = this.var_878.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_930 != this.var_1425)
               {
                  this.var_601 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1238:
               if(param1.testParamFlag(WindowParam.const_33))
               {
                  this.var_601 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1183:
               _loc4_ = true;
         }
         if(_loc4_)
         {
