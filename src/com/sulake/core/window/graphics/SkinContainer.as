package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1025:uint = 8;
      
      private static const const_1447:String = "skin";
      
      private static const const_1443:String = "bitmap";
      
      private static const const_1444:String = "fill";
      
      private static const const_1445:String = "text";
      
      private static const const_1446:String = "label";
      
      private static const const_1448:String = "shape";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2024 = new Dictionary();
         this.var_2802 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2024,this.var_2802);
         this.var_2804 = new Dictionary();
         this.var_2803 = new Dictionary();
         StateCodeTable.fillTables(this.var_2804,this.var_2803);
         this.var_457 = new Dictionary();
         this.var_457[const_1447] = BitmapSkinRenderer;
         this.var_457[const_1443] = BitmapDataRenderer;
         this.var_457[const_1444] = FillSkinRenderer;
         this.var_457[const_1445] = TextSkinRenderer;
         this.var_457[const_1446] = LabelRenderer;
         this.var_457[const_1448] = ShapeSkinRenderer;
         this.var_457[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_457[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_332 == null)
         {
            var_332 = new Array();
            var_332.push(WindowState.const_71);
            var_332.push(WindowState.const_84);
            var_332.push(WindowState.const_101);
            var_332.push(WindowState.const_54);
            var_332.push(WindowState.const_102);
            var_332.push(WindowState.const_85);
            var_332.push(WindowState.const_107);
            var_332.push(WindowState.const_99);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "HabboWindowManagerCom_habbo_skin_button_default_white_xml" : false;
                  ...
                  this.addSkinRenderer(this.var_2024[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1043[param1] = new Array(const_1025);
         }
         this.var_1043[param1][param2] = param3;
         if(this.var_1042[param1] == null)
         {
            this.var_1042[param1] = new Array(const_1025);
         }
         this.var_1042[param1][param2] = param4;
      }
      ...
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc4_ && param2 != WindowStyle.const_202)
            {
               _loc4_ = _loc3_["null"];
            }
         }
