   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_751.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_751.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_751.blueMultiplier = (param1.color & 255) / 255;
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_751);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_394 == SkinLayoutEntity.const_306)
                  {
                     var_27.x += _loc14_;
                  }
                  else if(_loc10_.var_394 == SkinLayoutEntity.const_566)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_394 == SkinLayoutEntity.const_324)
                  {
                     _loc12_ = true;
                     var_27.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.var_393 == SkinLayoutEntity.const_306)
                  {
                     var_27.y += _loc15_;
                  }
                  else if(_loc10_.var_393 == SkinLayoutEntity.const_566)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_393 == SkinLayoutEntity.const_324)
                  {
                     _loc13_ = true;
                     var_27.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_393 == SkinLayoutEntity.const_324 || _loc10_.var_394 == SkinLayoutEntity.const_324)
                  {
                  ...
                  {
                     this.var_250.a = var_27.width;
                     this.var_250.d = var_27.height;
                     this.var_250.tx = var_27.x;
                     this.var_250.ty = var_27.y;
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_394 == SkinLayoutEntity.const_306)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_393 == SkinLayoutEntity.const_306)
               {
