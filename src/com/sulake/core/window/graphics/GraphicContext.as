package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1731:uint = 0;
      
      public static const const_681:uint = 1;
      
      public static const const_1185:uint = 2;
      
      public static const const_699:uint = 4;
      
      public static const const_1537:uint = 8;
      
      public static const const_1671:uint = 16;
      
      public static const const_1901:uint = 64;
      
      public static const const_1894:uint = 128;
      
      public static const const_1203:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            case GraphicContext.const_681:
               ...
               break;
            case GraphicContext.const_1185:
               ...
               break;
            case GraphicContext.const_1537:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1671:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_699:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_212.numChildren > 0)
               {
                  this.var_212.removeChildAt(0);
               }
            }
            this.var_212 = null;
            while(numChildren > 0)
         ...
         if(this.var_866)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2096,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2096,16777215);
                  }
                  var_331 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_212 == null)
         {
            this.var_212 = new Sprite();
            this.var_212.name = this.name + " - Child Container";
            this.var_212.mouseEnabled = false;
      ...
      {
         return this.var_212 != null ? int(this.var_212.numChildren) : 0;
      }
