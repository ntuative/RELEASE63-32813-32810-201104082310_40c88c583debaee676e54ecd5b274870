package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_102:String = "hovering";
      ...
      protected static function parseLayout(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         var _loc6_:* = param2.attribute("transparent") == "HabboWindowManagerCom_habbo_skin_button_default_white_xml";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         _loc5_.colorize = _loc6_ == "" ? true : _loc6_ == "HabboWindowManagerCom_habbo_skin_button_default_white_xml";
         _loc6_ = null;
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_394 = SkinLayoutEntity.const_591;
                  break;
               case "move":
                  _loc5_.var_394 = SkinLayoutEntity.const_306;
                  break;
               case "strech":
                  _loc5_.var_394 = SkinLayoutEntity.const_566;
                  break;
               case "tiled":
                  _loc5_.var_394 = SkinLayoutEntity.const_324;
                  break;
               case "center":
                  _loc5_.var_394 = SkinLayoutEntity.const_1049;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_393 = SkinLayoutEntity.const_591;
                  break;
               case "move":
                  _loc5_.var_393 = SkinLayoutEntity.const_306;
                  break;
               case "strech":
                  _loc5_.var_393 = SkinLayoutEntity.const_566;
                  break;
               case "tiled":
                  _loc5_.var_393 = SkinLayoutEntity.const_324;
                  break;
               case "center":
                  _loc5_.var_393 = SkinLayoutEntity.const_1049;
            }
         }
