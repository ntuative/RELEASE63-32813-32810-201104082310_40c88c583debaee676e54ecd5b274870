package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_192:String = "regular";
      ...
      private static const const_1269:String = "/*";
      
      private static const const_1268:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_192],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_192] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_475.indexOf(_loc4_.name) == -1)
            {
               var_475.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "HabboWindowManagerCom_habbo_skin_button_default_white_xml" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_612) != countSubStrings(param1,const_613))
         {
            throw new Error("Mismatching amount of \"" + const_612 + "\" versus \"" + const_613 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1269) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1268) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_612)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
