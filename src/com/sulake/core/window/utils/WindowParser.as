package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1817:String = "_INCLUDE";
      
      public static const const_1884:String = "_TEMP";
      
      private static const const_1337:String = "layout";
      
      private static const const_980:String = "window";
      
      private static const const_978:String = "variables";
      
      private static const const_979:String = "filters";
      
      private static const const_438:String = "name";
      
      private static const const_1338:String = "style";
      
      private static const const_621:String = "params";
      
      private static const const_1336:String = "tags";
      ...
      private static const const_1334:String = "visible";
      
      private static const const_1341:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1238:String = "blend";
      ...
      private static const const_1333:String = "children";
      ...
      private static const const_1342:String = "height_max";
      ...
      private static const const_1345:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(this.var_1059,this.var_1584);
         this.var_2091 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1345,const_49);
         return param1.replace(const_1343,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1059)
            {
               delete this.var_1059[_loc1_];
            }
            for(_loc1_ in this.var_1584)
            {
               delete this.var_1584[_loc1_];
            }
            this.var_2091.dispose();
            this.var_2091 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1337)
         {
            _loc8_ = param1.child(const_978);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_979).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         name = unescape(String(this.parseAttribute(xml,const_438,variables,"")));
         style = uint(this.parseAttribute(xml,const_1338,variables,style));
         params = uint(this.parseAttribute(xml,const_621,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1336,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1334,variables,visible.toString()) == const_620;
         ...
         if(xml.child(const_621).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_438,variables,"") as String;
               if(this.var_1059[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_438)) + "\"!");
               }
               params |= this.var_1059[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1341,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1344);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_978)[0]),tags) as WindowController;
         ...
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1342,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_620;
         blend = Number(this.parseAttribute(xml,const_1238,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1340,variables,window.clipping.toString()) == const_620;
         ...
         list = xml.child(const_979).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
