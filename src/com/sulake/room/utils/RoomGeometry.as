package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_821:Number = 64;
      ...
      private var var_1679:Number = 1.0;
      
      private var var_1678:Number = 1.0;
      
      private var var_90:Vector3d;
      
      private var var_340:Vector3d;
      
      private var var_2897:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1681 = new Vector3d();
         this.var_491 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1102 = new Vector3d();
         this.var_1680 = 1;
         this.var_1679 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1678 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_1681.assign(this.var_152);
         return this.var_1681;
      }
      
      public function get location() : IVector3d
      {
         this.var_491.assign(this.var_90);
         this.var_491.x *= this.var_412;
         this.var_491.y *= this.var_411;
         this.var_491.z *= this.var_413;
         return this.var_491;
      }
      
      public function get direction() : IVector3d
      {
         this._direction.assign(this.var_340);
         return this._direction;
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_412 != param1 * this.var_1680)
         {
            this.var_412 = param1 * this.var_1680;
            ++this.var_151;
         }
      }
      ...
      {
         if(this.var_411 != param1 * this.var_1679)
         {
            this.var_411 = param1 * this.var_1679;
            ++this.var_151;
         }
      }
      ...
      {
         if(this.var_413 != param1 * this.var_1678)
         {
            this.var_413 = param1 * this.var_1678;
            ++this.var_151;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_90.x /= this.var_412;
         this.var_90.y /= this.var_411;
         this.var_90.z /= this.var_413;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_340.x;
         var _loc3_:Number = this.var_340.y;
         var _loc4_:Number = this.var_340.z;
         this.var_340.assign(param1);
         if(this.var_340.x != _loc2_ || this.var_340.y != _loc3_ || this.var_340.z != _loc4_)
         {
            ++this.var_151;
         }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_492 != null)
         {
            ...
            this.var_492.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_492.add(_loc3_,_loc4_);
            ++this.var_151;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_492 != null)
         {
            ...
            return this.var_492.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1102.assign(_loc22_);
         }
         else
         {
            this.var_1102.assign(_loc17_);
         }
         ++this.var_151;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_411;
         _loc2_.z *= this.var_413;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1102);
         if(_loc3_ < this.var_2897 || _loc3_ > this.var_2896)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_411;
            _loc2_.z *= this.var_413;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1102);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_90.x * this.var_412,this.var_90.y * this.var_411,this.var_90.z * this.var_413);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_152;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_412,param2.y * this.var_411,param2.z * this.var_413);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_412,param3.y * this.var_411,param3.z * this.var_413);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_412,param4.y * this.var_411,param4.z * this.var_413);
      ...
      public function performZoom() : void
      {
         ...
         {
            this.scale = const_821;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_821;
      }
