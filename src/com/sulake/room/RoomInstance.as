   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_242 != null)
         {
            ...
            {
               _loc3_ = this.var_242.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function createObjectInternal(param1:int, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(this.var_149 != null)
            {
               this.var_149.feedRoomObject(_loc6_);
            }
            return _loc6_;
         }
         return null;
      ...
      {
         return this.var_242.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_242.getValue(_loc2_) != null)
         {
            return this.var_242.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_242.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_242.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_242.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_242.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
