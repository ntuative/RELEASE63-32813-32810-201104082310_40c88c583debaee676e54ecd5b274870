package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1456:int = HabboMusicPrioritiesEnum.const_180;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_715.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_715.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_715)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_867,this.onJukeboxInit);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_265,this.onJukeboxDispose);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_851,this.onSoundMachineInit);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_887,this.onSoundMachineDispose);
         ...
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_228)
         {
            this.var_557[_loc6_] = null;
            this.var_849[_loc6_] = 0;
            _loc6_++;
         }
      }
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2043)
            {
            ...
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_506,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            {
               _loc2_ = 0;
               while(_loc2_ < this.var_462.length)
               {
                  _loc3_ = this.var_462.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_79)
            {
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_867,this.onJukeboxInit);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_265,this.onJukeboxDispose);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_851,this.onSoundMachineInit);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_887,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_228)
         {
            return false;
         }
         var _loc7_:SongStartRequestData = new SongStartRequestData(param2,param3,param4,param5,param6);
         this.var_557[param1] = _loc7_;
         this.var_849[param1] += 1;
         return true;
      }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_557[param1];
      ...
      private function getSongRequestCountAtPriority(param1:int) : int
      {
         ...
         return this.var_849[param1];
      }
      
      private function getTopRequestPriority() : int
      {
         var _loc1_:int = this.var_557.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_557[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_462.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_228)
         {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_462.add(_loc6_.id,_loc10_);
               ...
               this._events.dispatchEvent(new SongInfoReceivedEvent(SongInfoReceivedEvent.const_88,_loc6_.id));
               ...
               {
                  this._events.dispatchEvent(new SongDiskInventoryReceivedEvent(SongDiskInventoryReceivedEvent.const_563));
               }
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_228)
         {
            return false;
         }
         ...
         this.var_2043 = this.getSongRequestCountAtPriority(param1);
         this.var_2042 = param2;
         if(this._priorityPlaying <= const_1456)
         {
            this.notifySongPlaying(_loc4_);
         }
         if(param1 > HabboMusicPrioritiesEnum.const_180)
         {
            this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_547,param1,_loc4_.id,-1));
         }
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2838 != param1.id || _loc3_ > this.var_2839 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2838 = param1.id;
      ...
      private function onSongDiskInventoryMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDiskCount)
         {
            ...
            if(this.var_462.getValue(_loc6_) == null)
            {
