package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_67:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_67 = param2;
         this.var_715 = [];
         this.var_715.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_715.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_715)
         {
         ...
         this._events.addEventListener(SongInfoReceivedEvent.const_88,this.onSongInfoReceivedEvent);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_902,this.onSoundMachinePlayEvent);
         this.var_79.addEventListener(RoomEngineSoundMachineEvent.const_746,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_79)
            {
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_902,this.onSoundMachinePlayEvent);
               this.var_79.removeEventListener(RoomEngineSoundMachineEvent.const_746,this.onSoundMachineStopEvent);
               this.var_79 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_440);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_67.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_440 = -1;
         this.var_634 = false;
         this.var_67.stop(HabboMusicPrioritiesEnum.const_180);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_67.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_67.playSong(param1,HabboMusicPrioritiesEnum.const_180,_loc3_,0,0,0))
         {
