package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private var var_512:Number = 1.0;
      ...
      private var var_773:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_724,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_946.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            ...
            this.var_946.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_512;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_186.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_186.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1170.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_615,events);
         _loc5_.volume = this.var_512;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_615.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      {
         if(this.var_186 == null || this._connection == null || this._roomEngine == null || this.var_67 != null)
         {
            return;
         }
         this.var_67 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_67.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1599,this.var_772));
         this.var_772 = -1;
         this.var_773 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_512 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_512 * 100)));
         }
      }
      ...
      {
         this.var_512 = param1;
         this.var_67.updateVolume(this.var_512);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         this.var_161.events.dispatchEvent(_loc2_);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_614.remove(param1);
            if(this.var_615.getValue(_loc2_) == null)
            {
               _loc3_ = new ByteArray();
               _loc4_ = param1.length;
               param1.extract(_loc3_,int(_loc4_ * 44.1));
               _loc5_ = new TraxSample(_loc3_,_loc2_);
               this.var_615.add(_loc2_,_loc5_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1169.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1371 && this.var_1169.length > 0)
            {
               _loc3_ = this.var_1169.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_614.length == 0 && this.var_772 != -1)
            {
               this.var_773.ready = true;
               _loc4_ = this.var_772;
               this.var_772 = -1;
               this.var_773 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_724,_loc4_));
            }
         }
      }
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_773 == null && this.var_1170.length > 0)
         {
            _loc1_ = this.var_1170.getKey(0);
            _loc2_ = this.var_1170.remove(_loc1_);
            if(_loc2_ != null)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_724,_loc1_));
               }
               else
               {
                  this.var_773 = _loc2_;
