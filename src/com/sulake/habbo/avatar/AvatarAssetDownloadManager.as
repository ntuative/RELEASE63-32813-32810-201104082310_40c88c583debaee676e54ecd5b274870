package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_1040:int = 3;
      
      private var var_455:AssetLoaderStruct;
      ...
      private const const_2073:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_455 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_1039 = new Timer(this.const_2073,1);
         this.var_1039.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_455)
         {
            this.var_455.addEventListener(AssetLoaderEvent.const_29,this.onConfigurationComplete);
            this.var_455.addEventListener(AssetLoaderEvent.const_48,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_455)
         {
            this.var_455.removeEventListener(AssetLoaderEvent.const_29,this.onConfigurationComplete);
            this.var_455.removeEventListener(AssetLoaderEvent.const_48,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         {
            Logger.log("Could not download figuremap.xml. Retries left: " + this.var_1040);
            if(this.var_1564.indexOf("?") > 0)
            {
               _loc2_ = this.var_1564 + "&retry=" + this.var_1040;
            }
            else
            {
               _loc2_ = this.var_1564 + "?retry=" + this.var_1040;
            ...
            this.var_455 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2789,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_2013)
         {
            this.var_1272.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_507[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_507[_loc3_] = _loc6_;
            }
            this.var_1041[_loc3_] = _loc4_;
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:* = [];
         for(_loc3_ in this.var_1041)
         {
            _loc7_ = true;
            _loc4_ = this.var_1041[_loc3_];
            ...
            if(_loc7_)
            {
               ...
               delete this.var_507[_loc3_];
            }
         }
         for each(_loc3_ in _loc2_)
         {
            delete this.var_1041[_loc3_];
         }
         while(_loc6_ < this.var_831.length)
         {
            _loc5_ = this.var_831[_loc6_];
            if(_loc5_.libraryName == (param1.target as AvatarAssetDownloadLibrary).libraryName)
            {
               this.var_831.splice(_loc6_,1);
            }
            _loc6_++;
         }
         this.var_1039.start();
      ...
      {
         var _loc1_:* = null;
         while(this.var_832.length > 0 && this.var_831.length < this.const_1561)
         {
            _loc1_ = this.var_832[0];
            _loc1_.startDownloading();
            this.var_831.push(this.var_832.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_832.indexOf(param1) == -1 && this.var_831.indexOf(param1) == -1)
         {
