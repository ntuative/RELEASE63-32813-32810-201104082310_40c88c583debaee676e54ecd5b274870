package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      public function init() : void
      {
         ...
         this.var_633 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_633.numGridItems > 0)
         {
            this.var_633.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_66 = null;
      ...
      public function update() : void
      {
         ...
         for each(_loc2_ in this.var_66.hotLooks)
         {
            ...
            this.var_633.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_633.getGridItemIndex(param2.parent);
