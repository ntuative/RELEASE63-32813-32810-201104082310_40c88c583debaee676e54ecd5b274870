package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2679 = parseInt(param1.@paletteid);
         this.var_647 = new Dictionary();
         this.var_647["F"] = new Dictionary();
         this.var_647["M"] = new Dictionary();
         this.var_647["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_647["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_647["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_647["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      {
         return this.var_647[param1.toUpperCase()][Math.min(param2,1)];
      }
