package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2067:String = "hd-99999-99999";
      ...
      private var var_813:PaletteManager;
      ...
      private var var_1936:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_590 = RenderMode.const_1550;
         ...
         this.var_104.add(AvatarType.const_115,_loc4_);
         ...
         this.var_813 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_313.init();
         this.var_813.init();
         _loc2_ = this.var_104.getValue(AvatarType.const_115) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_104.getValue(AvatarType.const_115) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_186.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_228 == null)
               {
                  ...
                  _loc6_ = this.var_186.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_186.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1013)
         {
            if(this.var_2687 && this.var_2685 && this.var_2686)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_104.getValue(AvatarType.const_115) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1936)
         {
            this.var_1936 = new AvatarFigureContainer(this.const_2067);
         }
         this.var_228.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1936,param2);
      }
      ...
      public function getPetFigureString(param1:String) : String
      {
         ...
         return this.var_313.createPetFigureString(_loc3_,_loc4_,_loc5_);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1567)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_104.getValue(AvatarType.const_115) as AvatarStructure;
      ...
      public function get method_10() : PaletteManager
      {
         return this.var_813;
      }
