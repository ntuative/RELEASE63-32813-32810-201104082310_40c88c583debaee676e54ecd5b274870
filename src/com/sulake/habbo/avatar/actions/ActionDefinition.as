package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2713 = parseInt(param1.@precedence);
         this.var_2717 = String(param1.@activepartset);
         this.var_2718 = String(param1.@assetpartdefinition);
         this.var_2715 = String(param1.@lay);
         this.var_705 = String(param1.@geometrytype);
         this.var_2164 = Boolean(parseInt(param1.@main));
         this.var_2716 = Boolean(parseInt(param1.@const_1752));
         this.var_2719 = Boolean(parseInt(param1.@animation));
         this._preventHeadTurn = Boolean(String(param1.@preventheadturn == "HabboWindowManagerCom_habbo_skin_button_default_white_xml"));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_817.getValue(param1) == null)
         {
            this.var_817.add(param1,new Map());
         }
         var _loc4_:Map = this.var_817.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_817.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
