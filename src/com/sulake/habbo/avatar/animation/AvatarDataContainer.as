package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_2597 = parseInt(_loc2_,16);
         this.var_2598 = parseInt(_loc3_,16);
         ...
         this.var_751 = new ColorTransform(this.var_1967,this.var_1969,this.var_1968,this._alphaMultiplier);
         this.var_1203 = this.generatePaletteMapForGrayscale(this.var_2598,this.var_2597);
      }
      ...
      {
         return this.var_1203.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1203.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1203.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1203.getValue("alphas") as Array;
      }
