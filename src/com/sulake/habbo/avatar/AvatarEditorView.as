package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1580:IWindowContainer;
      
      public static var var_2065:int = 6710886;
      ...
      private var var_335:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1076 = [];
         this.var_1353 = [AvatarEditorFigureCategory.const_849,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_240,AvatarEditorFigureCategory.const_765,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_108];
         super();
         ...
         if(var_1580 == null)
         {
            ...
            var_1580 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_405 = new Timer(1000);
         this.var_405.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1353;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_405.stop();
            this.var_405.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_405 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1353);
         }
         if(param1.length != this.var_1076.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1076.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2156 = this.canChangeOutfit();
            this.var_405.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_335 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_335.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_335.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1076.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_335.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_335.numSelectables)
               {
                  this.var_335.getSelectableAt(_loc6_).x = this.var_335.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_335.setSelected(this.var_335.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1353;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1637 == AvatarEditorSideCategory.const_108 || this.var_2158))
         {
      ...
      {
         if(this.var_1637 == AvatarEditorSideCategory.const_108)
         {
            this.var_2158 = false;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_355 = param1;
         this.var_335.setSelected(this.var_335.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2157 = new Date().valueOf();
                  this.var_2156 = false;
                  this.var_405.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_480)
         {
            ...
            this.var_480 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_480.procedure = this.stripClubDialogEventProc;
            this.var_480.center();
         }
         else
         {
      ...
      private function openCatalogClubPage() : void
      {
         if(this._catalog)
         {
            this._catalog.openCatalogPage(CatalogPageName.const_196,true);
         }
      }
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2157 > 5000;
      }
   }
}
