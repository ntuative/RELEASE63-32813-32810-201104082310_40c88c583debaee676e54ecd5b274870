package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_240:AvatarImageCache;
      
      private var var_645:int = 0;
      
      private var var_1928:int = 0;
      
      private var var_599:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_599 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_599.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1545 = this.var_1142;
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_645);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_599,_loc13_,"pet",_loc12_.getDirection(),[]);
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_645);
                  _loc20_ = this.var_89;
                  _loc21_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_645);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_599,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_92)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_645);
                  _loc21_ = this.var_89;
                  _loc22_ = 1;
                  switch(this.var_89)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_535 = this.var_535 + param1 + _loc3_;
         switch(param1)
         {
            case AvatarAction.const_387:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1600:
                  case AvatarAction.const_1639:
                  case AvatarAction.const_1496:
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1020);
         this.getCache().resetBodyPartCache(this.var_1020);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1544 = this._structure.sortActions(this.var_329);
         ...
         {
            this.var_817 = this._structure.getCanvasOffsets(this.var_1544,this._scale,this.var_89);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1544)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_422)
               {
                  this.var_1019 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1142 = _loc4_.id;
                     this.var_1791 = _loc4_.breed;
                     break;
                  }
               }
            }
