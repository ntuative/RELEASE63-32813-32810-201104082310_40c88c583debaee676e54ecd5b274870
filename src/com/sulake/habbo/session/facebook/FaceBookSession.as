package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_952:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1271:String = "sendAccessTokenToServer";
      
      private static const const_1270:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1271,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1270,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_952);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_952);
         }
      }
