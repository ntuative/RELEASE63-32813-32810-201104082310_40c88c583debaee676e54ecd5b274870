package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1871:GroupDetailsView;
      ...
      private var var_624:ProductDataParser;
      ...
      private var var_1873:UserTagManager;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_308)
         {
            this.var_308.removeEventListener(FurnitureDataParser.const_121,this.onFurnitureReady);
            this.var_308.dispose();
            this.var_308 = null;
         }
         if(this.var_624)
         {
            this.var_624.removeEventListener(ProductDataParser.const_121,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         if(this.var_186 == null || this._localization == null)
         {
            return;
         }
         this.var_1479 = new BadgeImageManager(context.root.assets,events,this.var_186,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1873.communication = this._communication;
         this.var_1193.communication = this._communication;
         this.var_1194.communication = this._communication;
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_308)
         {
            ...
            this.var_308 = new FurnitureDataParser(this.var_524,this._wallItems,this.var_523,this._localization);
            this.var_308.addEventListener(FurnitureDataParser.const_121,this.onFurnitureReady);
            if(this.var_186.keyExists("furnidata.load.url"))
            {
               _loc3_ = this.var_186.getKey("furnidata.load.url");
      ...
      private function onFurnitureReady(param1:Event = null) : void
      {
         var _loc2_:* = null;
         this.var_308.removeEventListener(FurnitureDataParser.const_121,this.onFurnitureReady);
         for each(_loc2_ in this.var_973)
         {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2171 = _loc2_.clubLevel;
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2603 = _loc3_.respectTotal;
         this._respectLeft = _loc3_.respectLeft;
         this.var_793 = _loc3_.petRespectLeft;
         this.var_599 = _loc3_.figure;
         this.var_929 = _loc3_.sex;
         this.var_1620 = _loc3_.realName;
         this.var_2537 = _loc3_.identityId;
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            this.var_599 = _loc2_.figure;
            this.var_929 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this.var_599,this.var_929));
         }
      }
      ...
      {
         return this._securityLevel >= SecurityLevelEnum.const_1237;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1873.getTags(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1871 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1193.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1871.showGroupDetails(param1);
         }
      }
      ...
      {
         return this.var_1479.getBadgeImage(param1,BadgeImageManager.const_1097);
      }
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_793 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_793 = this.var_793 - 1;
      }
      ...
      public function openHabboHomePage(param1:int) : void
      {
         ...
         {
            urlString = this.var_186.getKey("link.format.userpage");
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(this.var_1192.indexOf(param1) == -1)
         {
            this.var_1192.push(param1);
         }
         if(this.var_624 == null)
         {
            _loc2_ = this.var_186.getKey("productdata.load.url");
            this.var_624 = new ProductDataParser(_loc2_,this.var_1185);
            this.var_624.addEventListener(ProductDataParser.const_121,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         {
            if(this.var_973.indexOf(param1) == -1)
            {
