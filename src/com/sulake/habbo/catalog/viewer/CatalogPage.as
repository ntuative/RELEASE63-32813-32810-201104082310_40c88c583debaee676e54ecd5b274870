package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_489:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1086:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_489 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1085);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1085);
      }
      ...
      protected function createWindow(param1:String) : Boolean
      {
         ...
         this.var_2088 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2088) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1716:
               if(this.var_1086 == null)
               {
                  this.var_1086 = new ItemGridCatalogWidget(param1);
                  this.var_35.push(this.var_1086);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1482:
               ...
               break;
            case CatalogWidgetEnum.const_1470:
            ...
            case CatalogWidgetEnum.const_1580:
               ...
               break;
            case CatalogWidgetEnum.const_1597:
            ...
            case CatalogWidgetEnum.const_1474:
               ...
               break;
            case CatalogWidgetEnum.const_1516:
               this.var_35.push(new ClubGiftWidget(param1,this._catalog.method_11()));
               break;
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_489.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_489 != null)
         {
            return this.var_489.dispatchEvent(param1);
         }
         return false;
      }
