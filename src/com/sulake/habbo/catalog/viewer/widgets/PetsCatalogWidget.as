package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2573 = _loc3_.localizationId;
         this.var_369 = [];
         if(page && false && page.viewer.catalog)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(this.var_527 < 0 || this.var_527 > this.var_369.length)
         {
            this.var_527 = 0;
         }
         this.updateImage();
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_203 == null || this.var_803 >= this.var_203.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_527 >= 0 && this.var_527 < this.var_369.length)
         {
            _loc7_ = this.var_369[this.var_527] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_203[this.var_803] as int;
         ...
         _loc4_.appendAction(AvatarAction.const_337,AvatarAction.const_713);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_527 >= this.var_369.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_369[this.var_527] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_203[this.var_803] as int;
