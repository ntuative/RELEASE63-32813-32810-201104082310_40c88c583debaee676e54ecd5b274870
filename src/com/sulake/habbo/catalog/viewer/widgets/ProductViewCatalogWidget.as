package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_550:IItemGridWindow;
      
      private var var_1560:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1035 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1264 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_2005 = new Point(this.var_87.x,this.var_87.y);
         this.var_550 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1560 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_2004 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_550 != null)
         {
            this.var_550.visible = false;
            this.var_550.destroyGridItems();
         }
         ...
         this.var_1035.text = _loc4_;
         this.var_1264.text = _loc5_;
         this.var_1035.height = this.var_1035.textHeight + 5;
         this.var_1264.y = this.var_1035.y + this.var_1035.height;
         this.var_1264.height = Math.max(130,this.var_1264.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_472:
                  _loc6_ = this.var_2004.clone();
                  if(this.var_550 != null)
                  {
                     this.var_550.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_550,this.var_1560,this.var_1846);
                     this.var_550.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_211:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_337,AvatarAction.const_531);
                              _loc16_.appendAction(AvatarAction.const_318,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2784)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2784 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_87 != null && true)
         {
            ...
            this.var_87.x = this.var_2005.x;
            this.var_87.y = this.var_2005.y;
            if(param3 != null)
            {
