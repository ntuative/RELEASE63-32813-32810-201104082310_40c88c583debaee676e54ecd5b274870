package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      protected var var_370:IGridItem;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_471 = _window.findChildByName("itemGrid") as IItemGridWindow;
      ...
      {
         if(param1 > -1 && param1 < this.var_471.numGridItems)
         {
            this.select(this.var_471.getGridItemAt(param1) as IGridItem);
         }
      }
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         while(_loc2_ < 3)
         {
            ...
            {
               _loc3_ = page.offers[this.var_828];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++this.var_1994;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1994);
         }
      }
