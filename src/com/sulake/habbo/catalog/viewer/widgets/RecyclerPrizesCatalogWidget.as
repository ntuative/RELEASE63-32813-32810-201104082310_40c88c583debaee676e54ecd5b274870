package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_619 = this.recycler.getPrizeTable();
         ...
         if(this.var_619.length > 0 && this.var_619[0].prizes.length > 0)
         {
            this.select(this.var_619[0].prizes[0] as IGridItem);
         }
         return true;
      }
      ...
      private function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         {
            this.createLevelItem(this.var_619[_loc2_]);
            _loc2_++;
         }
      }
