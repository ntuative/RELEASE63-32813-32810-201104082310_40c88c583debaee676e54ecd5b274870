package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2932:String = "magic.credits";
      
      private var var_2899:String = "magic.pixels";
      
      private var var_2900:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         _loc3_.addEventListener(WindowMouseEvent.const_28,this.onNavigatorEvent);
         ...
         _loc4_.addEventListener(WindowMouseEvent.const_28,this.onNavigatorEvent);
         ...
         _loc5_.addEventListener(WindowMouseEvent.const_28,this.onNavigatorEvent);
         this._scrollBar = this._container.findChildByName("navigationListScrollbar") as IScrollbarWindow;
         if(this._scrollBar != null)
         {
            this._scrollBar.visible = false;
            this._scrollBar.addEventListener(WindowEvent.const_877,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_267,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_931,this.deActivateScrollbar);
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_341.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_341)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_341.indexOf(_loc6_);
            this.var_341.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
      ...
      {
         this.openPage(this.var_2899);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2900,true);
      }
