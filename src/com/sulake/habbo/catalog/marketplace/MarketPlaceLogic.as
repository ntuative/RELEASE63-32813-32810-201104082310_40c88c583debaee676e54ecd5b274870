package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_2010:int = 1;
      
      public const const_1925:int = 2;
      
      public const const_2090:int = 3;
      ...
      private var var_223:MarketplaceConfirmationDialog;
      ...
      private var var_2672:MarketplaceItemStats;
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_223)
         {
            this.var_223 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_223.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2674,this.var_2673,this.var_2657,this.var_2676);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_2010,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_487)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2675 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1925,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2284 || param1.furniTypeId != this.var_2281)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1409)
               {
                  _loc2_ = true;
               }
            }
