package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_966:int = 0;
      ...
      {
         return this.var_595 != const_966;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1759 != RecyclerStatusMessageEvent.const_1135;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_595 == const_436;
      }
      ...
      {
         this.var_595 = const_967;
         this.var_111 = new Array(const_182);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1759)
         {
            case RecyclerStatusMessageEvent.const_1681:
               this.var_595 = const_436;
            ...
            case RecyclerStatusMessageEvent.const_1135:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1665:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1154:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1462:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_111.length < const_182)
         {
            return false;
         }
         var _loc1_:int = 0;
