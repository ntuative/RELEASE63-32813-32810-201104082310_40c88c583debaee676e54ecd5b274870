package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_282:Boolean = false;
      
      private static const const_614:String = "FriendBar";
      
      private static const const_615:String = "user_interaction";
      
      private static const TRACKING_EVENT_ACTION_VISIT:String = "visit_btn_click";
      
      private static const const_1274:String = "chat_btn_click";
      
      private static const const_1273:String = "find_friends_btn_click";
       
      
      private var var_193:IHabboCommunicationManager;
      
      private var var_877:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_193)
            {
               this.var_193.release(new IIDHabboCommunicationManager());
               this.var_193 = null;
            }
            if(this.var_877)
            {
               this.var_877.release(new IIDHabboMessenger());
               this.var_877 = null;
            }
            this.var_126 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_193)
         {
            this.var_193.getHabboMainConnection(null).send(new FollowFriendMessageComposer(param1));
            this.var_193.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_614,const_615,TRACKING_EVENT_ACTION_VISIT));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_877)
         {
            this.var_877.startConversation(param1);
            if(this.var_193)
            {
               this.var_193.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_614,const_615,const_1274));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_193)
         {
            this.var_193.getHabboMainConnection(null).send(new FindNewFriendsMessageComposer());
            this.var_193.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_614,const_615,const_1273));
         }
      }
      
      private function onCommunicationManagerAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_193 = param2 as IHabboCommunicationManager;
         this.var_193.addHabboConnectionMessageEvent(new MessengerInitEvent(this.onMessengerInitialized));
         this.var_193.addHabboConnectionMessageEvent(new FriendListUpdateEvent(this.onFriendListUpdate));
         this.var_193.addHabboConnectionMessageEvent(new FindFriendsProcessResultEvent(this.onFindFriendProcessResult));
      }
      
      private function onMessengerComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_877 = param2 as IHabboMessenger;
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc8_ in _loc5_)
         {
            ...
            if(_loc3_)
            {
               ...
               this.var_126.splice(this.var_126.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            ...
            else if(_loc4_.online || const_282)
            {
         ...
         {
            this.var_126 = !!const_282 ? this.sortByNameAndOnlineStatus(this.var_126) : this.sortByName(this.var_126);
         }
         events.dispatchEvent(new FriendBarUpdateEvent(FriendBarUpdateEvent.const_464));
      }
