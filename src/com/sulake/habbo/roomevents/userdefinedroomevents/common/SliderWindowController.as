package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_923);
         }
      ...
      {
         return int(this.var_1706 * (Number(param1 - this._minValue) / (this.var_1131 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1706 * (this.var_1131 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_924 || param1.type != WindowEvent.const_233)
         {
            return;
         }
         if(this.var_597 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_597) * this.var_597;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_597 != 0)
            {
               _loc3_ = this.var_923 + this.var_597;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_729 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_729.width,this.var_729.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_729,this.var_729.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_730 != null)
            {
               ...
               this.var_1706 = _loc1_.width - _loc2_.width;
            }
         }
