package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1867 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1187 = this.var_1867.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1187)
         {
            this.var_1187.procedure = this.onButtonClick;
         }
         this.var_1186 = this.var_1867.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1186)
         {
            this.var_1186.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_259 >= this.var_62.length - 1)
         {
            this.var_1186.disable();
         }
         else
         {
            this.var_1186.enable();
         }
         if(this.var_259 <= 0)
         {
            this.var_1187.disable();
         }
         else
         {
            this.var_1187.enable();
         }
      }
      ...
      {
         ++this.var_259;
         this.var_259 = Math.min(this.var_259,this.var_62.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_62[this.var_259][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_62[this.var_259][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_62[this.var_259][1]).value;
