package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1383:int = 2;
      ...
      private var var_1704:TriggerConfs;
      
      private var var_1702:ActionTypes;
      
      private var var_1703:ConditionTypes;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1114 = new SliderWindowController(this.var_79,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_79.assets,0,20,1);
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_137.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = this.var_36.stuffTypeSelectionCode < 1 ? int(var_1383) : int(this.var_36.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.stuffTypeSelectionCode = (this.var_36.stuffTypeSelectionCode + 1) % (var_1383 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1704);
         this.refreshConfigureElement(this.var_1702);
         this.refreshConfigureElement(this.var_1703);
