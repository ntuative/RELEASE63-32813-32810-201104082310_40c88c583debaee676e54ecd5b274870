package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2705 = param2.pickerUserId;
         this.var_2706 = param2.pickerUserName;
         this.var_1433 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_815 == null || param1.timeStamp < this.var_815.timeStamp)
         {
            this.var_815 = param1;
         }
         if(this.var_814 == null || param1.priority > this.var_814.timeStamp)
         {
            this.var_814 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_814;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_815;
         if(_loc2_ == null)
         {
