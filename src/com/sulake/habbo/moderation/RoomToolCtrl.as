package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_539:ITextFieldWindow;
      
      private var var_637:Boolean = true;
      
      private var var_987:ICheckBoxWindow;
      
      private var var_1488:ICheckBoxWindow;
      
      private var var_1487:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_34.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_374));
      ...
      public function populate() : void
      {
         ...
         this.var_539 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_539.procedure = this.onInputClick;
         this.var_1100 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1100);
         this.var_1100.procedure = this.onSelectTemplate;
         this.var_987 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1488 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1487 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_34,WindowTracker.const_858,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_637 || this.var_539.text == "")
         {
            this.var_34.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_987.isSelected);
         this.var_34.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1630,_loc2_,this.var_539.text,"",""));
         if(this.var_1488.isSelected || this.var_1487.isSelected || this.var_987.isSelected)
         {
            this.var_34.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1488.isSelected,this.var_1487.isSelected,this.var_987.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1613);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1492);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_34.initMsg.roomMessageTemplates[this.var_1100.selection];
         if(_loc3_ != null)
         {
            this.var_637 = false;
            this.var_539.text = _loc3_;
         }
      }
   }
}
