package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_908:Array = [];
      
      private static var var_1729:int = 200;
      ...
      private var var_1661:IMessageComposer;
      ...
      {
         this.var_733 = IWindowContainer(this.var_34.getXmlWindow("chatlog_roomheader"));
         this.var_734 = IWindowContainer(this.var_34.getXmlWindow("chatlog_chatline"));
         ...
         this.var_34.connection.send(this.var_1661);
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_908.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_733.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_908.length < var_1729)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_733.width;
            param1.height = this.var_733.height;
            var_908.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1394.getValue(param2.chatterName))
            {
               this.var_1394.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1394.getValue(_loc2_);
