package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_920:Array = [];
      ...
      {
         this.var_740 = IWindowContainer(this.var_34.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_920.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_740.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_920.length < var_1758)
         {
            ...
            param1.width = this.var_740.width;
            param1.height = this.var_740.height;
            var_920.push(param1);
         }
         else
         {
