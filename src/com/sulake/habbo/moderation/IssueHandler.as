package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_486:UserInfoCtrl;
      
      private var var_1082:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_486 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         this.var_1082 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
         this.var_486.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1082.load(_loc4_,this.var_150.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_65.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_65,WindowTracker.const_1159,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_486 = new UserInfoCtrl(this._window,this.var_65,_loc3_.message);
            this.var_486.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
