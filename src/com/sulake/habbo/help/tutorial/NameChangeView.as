   ...
   public class NameChangeView
   {
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1779 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_749)
         {
            this.var_749 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_749)
            {
               return;
            }
            this._window.content.addChild(this.var_749);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_748)
         {
            this.var_748 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_748)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_748.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1055 || param1 == ChangeUserNameResultMessageEvent.var_1057)
         {
         ...
         while(_loc7_ < _loc5_.numChildren)
         {
            ...
            _loc8_.addEventListener(WindowMouseEvent.const_28,this.nameOut);
            _loc7_++;
         }
      }
