package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_749)
         {
            this.var_749 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_749)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_748)
         {
            this.var_748 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_748)
            {
               return;
            }
