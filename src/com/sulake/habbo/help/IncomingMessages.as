   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            {
               this.var_2357 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_22.tellUI(HabboHelpViewEnum.const_759);
      }
      ...
      {
         this.var_22.showUI(HabboHelpViewEnum.const_391);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         this.var_22.tellUI(HabboHelpViewEnum.const_184);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_507);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_1053);
         this.var_22.tellUI(HabboHelpViewEnum.const_1053,_loc5_);
      }
