package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_810:FaqCategory;
      
      private var var_811:FaqCategory;
      
      private var var_812:FaqCategory;
      ...
      {
         super();
         this.var_810 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_811 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_812 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_810.hasItem(param1))
         {
            this.var_810.getItem(param1).answerText = param2;
         }
         if(this.var_811.hasItem(param1))
         {
            this.var_811.getItem(param1).answerText = param2;
         }
         if(this.var_812.hasItem(param1))
         {
            this.var_812.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_810.hasItem(param1))
         {
            return this.var_810.getItem(param1);
         }
         if(this.var_811.hasItem(param1))
         {
            return this.var_811.getItem(param1);
         }
         if(this.var_812.hasItem(param1))
         {
            return this.var_812.getItem(param1);
         }
         var _loc2_:int = 0;
