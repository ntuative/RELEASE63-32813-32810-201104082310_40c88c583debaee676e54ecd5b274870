package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201104082303));
         this.var_161 = param5;
         this.var_113 = new Map();
         this.var_113.add(HabboHelpViewEnum.const_1527,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_184,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_507,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_316,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_261,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_391,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_747,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_241,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_113.add(HabboHelpViewEnum.const_1187,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_113.add(HabboHelpViewEnum.const_1163,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_113.add(HabboHelpViewEnum.const_759,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_510.length == 0 || param1 != this.var_355)
            {
               this.var_510.push(this.var_355);
            }
         }
         this.var_355 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_241:
               ...
               break;
            case CallForHelpResultEnum.const_1244:
               this.showUI(HabboHelpViewEnum.const_1163);
               break;
            case CallForHelpResultEnum.const_1144:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_113.getValue(HabboHelpViewEnum.const_184) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_458));
      }
      ...
      {
         return this.var_113.getValue(this.var_355);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2481 = this._window.width - _loc3_.width;
         this.var_2479 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2479;
         this._window.width = _loc1_.width + this.var_2481;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_355 == HabboHelpViewEnum.const_184)
         {
            return;
         }
         if(this.var_613.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_613.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_613.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_354.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_613[1],this.var_613[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_613[0],this.var_613[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_355 == HabboHelpViewEnum.const_184 || this.var_510.length == 0)
         {
            return;
         }
         if(this.var_354 == null)
         {
            ...
            this.var_354 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_354.findChildByName("back_image");
            if(_loc3_ != null)
            {
               _loc3_.setParamFlag(WindowParam.const_31);
               _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onBack);
               _loc3_.addEventListener(WindowMouseEvent.const_28,this.onMouseOut);
               _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOver);
            }
            _loc4_ = this.var_354.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_354 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_354 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_354 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
