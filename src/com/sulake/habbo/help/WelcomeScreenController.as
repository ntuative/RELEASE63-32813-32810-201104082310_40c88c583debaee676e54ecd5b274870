package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      {
         return this._notifications[this.var_1506];
      }
      ...
      public function dispose() : void
      {
         if(this.var_137)
         {
            this.var_137.removeUpdateReceiver(this);
            this.var_137.toolbar.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
            this.var_137.toolbar.events.removeEventListener(HabboToolbarEvent.const_891,this.onToolbarResized);
            this.var_137 = null;
         }
         ...
         {
            this.var_806.stop();
            this.var_806.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_806 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_137.toolbar.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClicked);
         this.var_137.toolbar.events.addEventListener(HabboToolbarEvent.const_891,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_806 = new Timer(_loc4_);
         this.var_806.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
         this.var_806.start();
      }
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_218.y = this.var_137.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
      ...
      {
         var _loc1_:XmlAsset = this.var_137.assets.getAssetByName("welcome_screen_xml") as XmlAsset;
         ...
         var _loc3_:BitmapDataAsset = this.var_137.assets.getAssetByName("welcome_screen_arrow") as BitmapDataAsset;
         ...
         _loc4_.content.setParamFlag(WindowParam.const_288,false);
         _loc4_.height -= 20;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_96,this.current.targetIconId);
         _loc2_.iconState = !!param1 ? "highlight_blue" : "0";
         this.var_137.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1506 < this._notifications.length - 1)
         {
            ++this.var_1506;
         }
         else
      ...
      {
         this.var_137.removeUpdateReceiver(this);
         this.var_137.registerUpdateReceiver(this,10);
      }
   }
}
