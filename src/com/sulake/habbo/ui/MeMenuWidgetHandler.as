   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_884,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_843,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_161 && !this.var_161.disposed && this.var_161.events)
            {
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_445,this.onHelpTutorialEvent);
         ...
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_884,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_843,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_445,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1498)
            {
               ...
               this.var_1894 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1894;
            }
         }
         if(this.var_161 != null)
         {
            ...
            this.var_161.events.dispatchEvent(_loc5_);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_885);
         _loc1_.push(RoomWidgetDanceMessage.const_723);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_778);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_712);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_936);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_795);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_897);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_415);
         _loc1_.push(RoomWidgetStopEffectMessage.const_755);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1668);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1114);
         _loc1_.push(RoomWidgetToolbarMessage.const_905);
         _loc1_.push(RoomWidgetToolbarMessage.const_926);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_416);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1724);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1194);
         ...
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1750);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_896);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_847);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_839);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_776:
               ...
               break;
            case RoomWidgetWaveMessage.const_885:
            ...
            case RoomWidgetDanceMessage.const_723:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_778:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_712:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_936:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_897:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1048:
                        this._catalog.openCatalogPage(CatalogPageName.const_1552,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1149:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_297);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1514:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_82);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1604:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_755:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_1176:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1549:
                     break;
                  default:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_769:
               ...
               break;
            case RoomWidgetToolbarMessage.const_905:
               ...
               if(this.var_161)
               {
                  this.var_161.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_60,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
               ...
               break;
            case RoomWidgetToolbarMessage.const_926:
               ...
               {
                  this.var_161.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_542,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            ...
            case RoomWidgetGetSettingsMessage.const_861:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_386,this._container.soundManager.volume));
               break;
            ...
            case RoomWidgetClothingChangeMessage.const_360:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_946));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_814));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_445:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_535));
         }
      }
