   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_163,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_145,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_173,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_163,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_145,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_173,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_585.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_585.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_227);
         ...
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_909);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_908);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1605);
         _loc1_.push(RoomWidgetPetCommandMessage.const_520);
         _loc1_.push(RoomWidgetPetCommandMessage.const_838);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_583)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_420 || param1.type == RoomWidgetUserActionMessage.const_561 || param1.type == RoomWidgetUserActionMessage.const_575)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetFurniActionMessage.const_898:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_227:
            ...
            case RoomWidgetRoomTagSearchMessage.const_911:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_909:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_908:
            ...
            case RoomWidgetUserActionMessage.const_702:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_838:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_25:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_286);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_559) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_559);
               }
               ...
               {
                  _loc25_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_338);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1190);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1057);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc29_ = "";
                  _loc30_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_823)
                  {
                     _loc31_ = this.var_67.getRoomItemPlaylist();
                     if(_loc31_ != null)
                     {
                  ...
                  {
                     _loc32_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_393.length);
                     _loc27_ = parseInt(_loc32_);
                     _loc30_ = "null";
                  }
                  if(_loc27_ != -1)
                  {
                     _loc33_ = this.var_67.getSongInfo(_loc27_);
                     if(_loc33_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_201)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc13_.webID);
                  return null;
               }
               if(_loc13_.type == RoomObjectTypeEnum.const_194)
               {
                  _loc14_ = "null";
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_912)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc18_ != null)
               {
                  _loc15_.carryItem = _loc18_.getModel().getNumber(RoomObjectVariableEnum.const_548);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_119)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_133)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     _loc39_ = _loc18_.getModel().getString(RoomObjectVariableEnum.const_730);
                  ...
                  if(!_loc35_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1078;
                  }
                  if(!_loc36_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1046;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1538);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_149];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_149:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_585.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_585.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_67 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_67.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_401,_loc2_,_loc3_,_loc4_));
         }
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_67 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_395,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
