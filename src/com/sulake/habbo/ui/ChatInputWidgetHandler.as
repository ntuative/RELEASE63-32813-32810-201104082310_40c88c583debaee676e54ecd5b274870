package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         this.var_161 = this._container.toolbar;
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_882);
         _loc1_.push(RoomWidgetChatTypingMessage.const_942);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_882:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_942:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_161.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_1199,HabboToolbarIconEnum.CHATINPUT,param1));
      }
      
      public function getProcessedEvents() : Array
      {
         return [RoomSessionChatEvent.const_528];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_528:
