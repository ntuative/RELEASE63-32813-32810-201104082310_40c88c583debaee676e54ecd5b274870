package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_1007:Boolean;
      
      protected var _selected:Boolean;
      
      protected var var_2881:String;
      ...
      protected var var_698:BitmapData;
      
      protected var var_2342:int;
      
      protected var var_1587:Boolean;
      
      protected var var_2102:Boolean;
      
      protected var var_2880:BitmapData;
      
      private const const_2033:int = 8947848;
      
      private const const_2034:int = 13421772;
      
      private const const_1802:Number = 1;
      
      private const const_1803:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2881 == FurniModel.const_47)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1374));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_806)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1803;
               _loc1_.blend = this.const_1803;
            }
            else
            {
               this._window.blend = this.const_1802;
               _loc1_.blend = this.const_1802;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_2102 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2880;
               _loc5_.visible = true;
            }
            else
            {
