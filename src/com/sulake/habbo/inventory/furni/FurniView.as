package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2087:int = 0;
      ...
      private const const_1787:int = 42;
      
      private const const_1785:int = 120;
      ...
      private var var_802:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_434.add(FurniModel.const_47,new FurniGridView(this.var_66,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_434.add(FurniModel.const_50,new FurniGridView(this.var_66,FurniModel.const_50,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_434.getValue(this.var_433);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_66.getCategoryContent(this.var_433);
         ...
         {
            _loc2_ = this.const_1788;
         }
         else
         {
            _loc2_ = this.const_1786;
         }
         if(this.var_2416 == _loc2_)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_66.getGroupItemInIndex(_loc3_,this.var_433);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_310);
            _loc17_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_326);
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_305);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_802 && this.var_802.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1073)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1785)
         {
            _loc3_ = this.const_1785;
         }
         else if(_loc3_ < this.const_1787)
         {
            _loc3_ = this.const_1787;
         }
         else
         {
