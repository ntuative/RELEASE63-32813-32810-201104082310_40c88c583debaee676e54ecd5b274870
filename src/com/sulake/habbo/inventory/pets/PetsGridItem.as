package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_43:
               this.var_1403.setSelectedGridItem(this);
               this.var_1402 = true;
               break;
            ...
            case WindowMouseEvent.const_28:
               ...
               {
                  this.var_1402 = false;
                  this.var_1403.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1336.color = !!this._isSelected ? uint(this.const_2033) : uint(this.const_2034);
      }
