package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2909:IWindowContainer;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_161)
         {
            if(this.var_161.events)
            {
               this.var_161.events.removeEventListener(HabboToolbarEvent.const_73,this.onHabboToolbarEvent);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this.var_161 != null && this.var_1166)
         {
            this.var_161.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_60,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            this.var_1166 = false;
         }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_771 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this.var_161 != null && this.var_1166)
            {
               this.var_161.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_60,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
               this.var_1166 = false;
            }
      ...
      public function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_161.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1829);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_771 == InventoryCategory.const_147)
            {
               this.toggleCategoryView(InventoryCategory.const_147);
            }
            else if(this.var_771 == InventoryCategory.const_82)
            {
