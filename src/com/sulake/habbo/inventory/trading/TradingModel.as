package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1458:uint = 9;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_54.updateItemList(this.var_767);
         this.var_54.updateItemList(this.var_1443);
      ...
      public function close() : void
      {
         if(this.var_753)
         {
            if(this._state != const_181 && this._state != const_260)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_766 + " OTHER: " + this.var_1159);
         ...
         {
            case const_181:
               if(param1 == const_207 || param1 == const_260)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_254.length)
         {
            _loc2_ = this.var_254.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_54.alertPopup(TradingView.const_1102);
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_54.alertPopup(TradingView.const_1201);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_254.length < const_1458)
         {
