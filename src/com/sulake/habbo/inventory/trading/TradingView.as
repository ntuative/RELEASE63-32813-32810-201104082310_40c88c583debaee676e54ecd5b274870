package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1006:uint = 4284532064;
      
      private static const const_1005:uint = 2577770;
      ...
      private var var_1009:GroupItem;
      ...
      private function createNormalWindow() : IWindowContainer
      {
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_28,this.ownThumbEventProc);
            _loc6_++;
         }
         ...
         while(_loc6_ < _loc3_.numGridItems)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_28,this.othersThumbEventProc);
            _loc6_++;
         }
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_69)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_1006) : uint(const_1005);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_1006) : uint(const_1005);
            }
      ...
      public function removeSelection() : void
      {
         if(this.var_1009)
         {
            this.var_1009.isSelected = false;
            this.var_1009 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1497)
            {
            ...
            this.var_650.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_493);
            this.var_650.show();
         }
         ...
         if(this.var_183.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_650.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_493);
               }
            }
            else
            {
