package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_957:int = 5;
      
      private static const const_1278:int = 250;
      ...
      {
         this.var_337 = new Timer(const_1278,1);
         this.var_338 = new Timer(const_1280,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         this.var_338.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_338.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_338.stop();
            this.var_338 = null;
         }
         this._assets = null;
      ...
      public function show() : void
      {
         ...
         {
            case const_1152:
               this.var_78.x = -1 * this.var_78.width - const_957;
               break;
            case const_493:
               this.var_78.x = this._parent.width + const_957;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         switch(param1)
         {
            case const_1152:
               ...
               _loc2_.y = (this.var_78.height - this.var_883.height) / 2;
            ...
            case const_493:
               ...
               _loc2_.y = (this.var_78.height - this.var_714.height) / 2;
