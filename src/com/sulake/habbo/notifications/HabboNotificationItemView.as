package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_938:int = 70;
      
      public static const const_503:int = 4;
      
      private static const name_3:int = 0;
      
      private static const const_572:int = 1;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1742 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1742 = 15;
         }
         this.var_1741 = this._window.height;
         this.var_737 = 4;
         this.var_738 = 0;
         this._state = name_3;
         this.var_161 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_572:
               ...
               _loc2_ = Number(this.var_1123) / Number(this.var_415["time_fade_in"]);
               if(this.var_1123 > int(this.var_415["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_964:
               ...
               if(this.var_1405 > int(this.var_415["time_display"]) && !this.var_1740)
               {
                  this.startFadeOut();
               }
               break;
            case const_965:
               ...
               _loc3_ = 1 - Number(this.var_1124) / Number(this.var_415["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1124 > int(this.var_415["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1742;
         if(this._window.height < this.var_1741)
         {
            this._window.height = this.var_1741;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_161.orientation == "TOP" ? int(const_435) : 0;
         var _loc4_:int = this.var_161.orientation == "BOTTOM" ? int(_loc2_.height - const_435) : int(_loc2_.height);
         var _loc5_:int = this.var_161.orientation == "LEFT" ? int(const_435) : 0;
         var _loc6_:int = this.var_161.orientation == "RIGHT" ? int(_loc2_.width - const_435) : int(_loc2_.width);
         if(this.var_415["position_horizontal_follow_toolbar"] == "HabboWindowManagerCom_habbo_skin_button_default_white_xml" && (this.var_161.orientation != "TOP" && this.var_161.orientation != "BOTTOM"))
         {
            if(this.var_161.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_503;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_503;
            }
         }
         ...
         if(this.var_415["position_vertical_follow_toolbar"] == "HabboWindowManagerCom_habbo_skin_button_default_white_xml" && (this.var_161.orientation != "RIGHT" && this.var_161.orientation != "LEFT"))
         {
            if(this.var_161.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_737;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_737;
            }
         }
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_738;
      }
   }
}
