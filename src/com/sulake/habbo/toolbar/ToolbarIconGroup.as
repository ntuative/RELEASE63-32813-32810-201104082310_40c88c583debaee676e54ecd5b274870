package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return this.var_1354.indexOf(param1) > -1;
      }
               ...
               if(!this.containsIcon(_loc2_))
               {
                  ...
                  if(_loc5_.length() > 0)
                  {
                     ...
                     while(_loc9_ < _loc5_.length())
                     {
                        ...
                        _loc6_.dockMenu(_loc3_,this.getMenuYieldList(_loc3_),_loc5_[_loc9_].@locktoicon == "HabboWindowManagerCom_habbo_skin_button_default_white_xml");
                        _loc9_++;
                     }
                  }
                  else
      ...
      private function alignItems() : void
      {
         ...
         {
            _loc2_ = this.var_709.indexOf(this.var_1355[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_290[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1149 + _loc3_);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_290[this.var_709.indexOf(param1)];
      }
