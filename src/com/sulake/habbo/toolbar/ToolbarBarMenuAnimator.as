package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_222:Boolean = true;
      
      private static const const_1431:Number = 25;
      
      private static const const_1435:Number = 90;
      ...
      private var var_1554:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_664 = new Object();
         this.var_662 = new Array();
         this.var_663 = new Array();
         super();
         this._windowManager = param1;
         this.var_1554 = param2;
         this.var_825 = new Timer(const_1431);
         this.var_825.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_382[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_1017 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_1017 || param1.desktop.height - param1.y < const_1432;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1554.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_382.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1554.getIconLoc(param1.iconId);
      ...
      {
         return this.var_662[this.var_663.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_663[this.var_662.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_663.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_663.splice(_loc3_,1);
            this.var_662.splice(_loc3_,1);
         }
         this.var_662.push(param1.name);
         this.var_663.push(param2);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_664[_loc3_] == null)
            {
               this.var_664[_loc3_] = new Array();
            }
            if(this.var_664[_loc3_].indexOf(param1) < 0)
            {
               this.var_664[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(this.var_382.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               this.var_382.splice(this.var_382.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_662.length)
         {
            if(this.var_662[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_663[_loc2_];
               if(this.var_664[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_664[_loc3_].length)
                  {
                     this.repositionWindow(this.var_664[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_382.length)
         {
            _loc2_ = this._itemList[this.var_382[_loc7_]];
            if(_loc2_.active)
            {
