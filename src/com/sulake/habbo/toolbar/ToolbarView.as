package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_548:String = "LEFT";
      
      private var var_168:Number = 50;
      
      private var var_1262:Boolean = true;
      
      private var var_1261:Number = 1;
      
      private var var_1556:Number = 0;
      
      private var var_1995:Number = 15;
      
      private var var_1996:Number = 5;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IConnection, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_235 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_65,HabboWindowStyle.const_1229,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         this._window.tags.push("habbo_extrabar");
         if(param5.getKey("friendbar.enabled") == "HabboWindowManagerCom_habbo_skin_button_default_white_xml")
         {
         ...
         this.var_1262 = String(_loc8_.relocate_by_drag.@state) == "HabboWindowManagerCom_habbo_skin_button_default_white_xml";
         if(this.var_1262)
         {
         ...
         this.var_1261 = _loc8_.toolbar.@margin_top;
         this.var_1556 = _loc8_.toolbar.@margin_bottom;
         this.var_1995 = _loc8_.toolbar.@min_group_margin;
         this.var_1996 = _loc8_.toolbar.@margin_to_extrabar;
         ...
         this.createGroupsFromXmlList(_loc9_,this.var_276,param1,param2,param3,this._window,this.var_301);
         this.createGroupsFromXmlList(_loc10_,this.var_665,param1,param2,param3,this.var_235,this.var_301);
         this.alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(this.var_665.length > 0)
         {
            _loc1_ = this.var_665.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_168,this.var_548,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_548);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_168,this.var_548);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_168,this.var_548);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_891);
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_235.x = this.var_168 + this.var_1996;
               this.var_235.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_235.x = 0;
               this.var_235.y = this.var_168 + this.var_1996;
         ...
         _loc4_ -= this.var_1556;
         _loc4_ -= this.var_1261;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1261;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_276.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1995,(this._window.height - _loc5_ * _loc8_ - this.var_1261 - this.var_1556) / (this.var_276.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1995,(this._window.width - _loc5_ * _loc8_ - this.var_1261 - this.var_1556) / (this.var_276.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_276.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_548;
