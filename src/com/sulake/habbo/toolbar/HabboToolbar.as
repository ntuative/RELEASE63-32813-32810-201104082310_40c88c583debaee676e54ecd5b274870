package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1382:LogoutController;
      ...
      {
         this._view = new ToolbarView(this._windowManager,this._assetLibrary,this.var_297.getHabboMainConnection(null),events,this._config);
         if(this._config && this._config.getKey("client.logout.enabled","false") == "HabboWindowManagerCom_habbo_skin_button_default_white_xml")
         {
            this.var_1382 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this._view == null)
         {
            return;
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_171,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_542,this.onAnimateWindowEvent);
