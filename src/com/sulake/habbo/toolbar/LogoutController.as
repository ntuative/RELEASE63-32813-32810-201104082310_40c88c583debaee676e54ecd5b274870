package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private const const_595:int = 46;
      
      private const const_490:int = 3;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_490;
         _loc3_.y = this.const_595;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_669)
         {
            this.var_669 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_37);
