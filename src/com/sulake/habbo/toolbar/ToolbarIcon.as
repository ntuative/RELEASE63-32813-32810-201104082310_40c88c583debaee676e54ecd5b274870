package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIcon
   {
      ...
      private var var_1160:ToolbarIconBouncer;
      ...
      public function ToolbarIcon(param1:ToolbarIconGroup, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:String, param6:IEventDispatcher, param7:ToolbarBarMenuAnimator)
      {
         ...
         this.var_1160 = new ToolbarIconBouncer(0.8,1);
         super();
         this.var_511 = param1;
         ...
         this._events = param6;
         this.var_301 = param7;
         this.var_1447 = new Timer(40,40);
         this.var_1447.addEventListener(TimerEvent.TIMER,this.updateBouncer);
         ...
         this.var_356 = this._region.findChildByName("label") as ITextWindow;
      }
      ...
      public function defineFromXML(param1:XML) : void
      {
         ...
         this.var_1162 = param1.@id;
         this.var_2484 = int(param1.@window_offset_from_icon);
         this.var_2161 = int(param1.@window_margin);
         this.var_2908 = param1.@label;
         ...
         if(_loc2_.length() > 0)
         {
            ...
            while(_loc3_ < _loc2_.length())
            {
               ...
               this.var_1164.push(_loc5_.id);
               this.var_1828.push(_loc5_);
               if(_loc3_ == 0)
               {
                  if(this.var_1448 == "-1")
                  {
                     this.var_1448 = _loc5_.id;
                  }
                  if(this.var_1165 == "-1")
                  {
      ...
      private function setAnimator() : void
      {
         ...
         if(_loc1_ != null && this.var_1161)
         {
            ...
            {
               this.var_945 = new Timer(_loc1_.timer);
               this.var_945.addEventListener(TimerEvent.TIMER,this.updateAnimator);
               this.var_945.start();
            }
            if(_loc1_.bounce)
            {
               this.var_1160.reset(-7);
               this.var_1447.reset();
               this.var_1447.start();
            }
         }
      ...
      public function menuLockedToIcon(param1:String) : Boolean
      {
         ...
         var _loc2_:MenuSettingsItem = this.var_1163[this.var_769.indexOf(param1)];
      ...
      {
         return this.var_1828[this.var_1164.indexOf(param1)];
      }
      ...
      private function setTooltip() : void
      {
         ...
         {
            this._region.toolTipCaption = "${toolbar.icon.tooltip." + this.var_1162.toLowerCase() + "}";
         }
      ...
      private function setLabel() : void
      {
         ...
         {
            this.var_356.caption = "${toolbar.icon.label." + _loc1_.label + "}";
         }
         else
         {
            this.var_356.caption = "${toolbar.icon.label." + this.var_1162.toLowerCase() + "}";
         }
         this.updateRegion();
      }
      ...
      {
         return this.var_2161 + this.var_511.windowMargin;
      }
      ...
      {
         if(this.var_1160 != null && this._icon != null)
         {
            this.var_1160.update();
            this._icon.y = this.var_1160.location;
         }
      }
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               ...
               if(this._events != null)
               {
                  ...
                  _loc4_.iconName = this.var_1162;
                  _loc5_ = new ConversionPointMessageComposer("Toolbar",this.var_1162,"client.toolbar.clicked");
                  if(this._connection)
                  {
      ...
      private function updateRegion() : void
      {
         ...
         this.var_356.y = this._icon.height;
         this._region.width = Math.max(this._icon.width,this.var_356.width);
         this._region.height = this._icon.height + this.var_356.height;
         this._icon.x = (this._region.width - this._icon.width) / 2;
         this.var_356.x = (this._region.width - this.var_356.width) / 2;
         ...
         if(_loc1_)
         {
            ...
            this.var_153 = this.var_1149 + (this.var_511.iconSize - this._region.height) / 2;
         }
         else
         {
            this._x = this.var_1149 + (this.var_511.iconSize - this._region.width) / 2;
            this.var_153 = (this.var_511.toolbarUsableWidth - this._region.height) / 2;
         }
