package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         this.var_818 = ITextFieldWindow(param1.findChildByName("search_str"));
         this.var_818.procedure = this.onSearchInput;
         this.var_818.addEventListener(WindowKeyboardEvent.const_203,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_60.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_390,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
