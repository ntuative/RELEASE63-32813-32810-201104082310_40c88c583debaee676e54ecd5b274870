package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_176:String = "face";
      ...
      private var var_2458:FriendListLookAndFeel;
      
      private var var_431:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1816:OpenedToWebPopup;
      ...
      private var var_1817:AvatarSearchResults;
      ...
      {
         this.var_2458 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_100 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1817 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1150)
         {
            this.var_1150.release(new IIDAvatarRenderManager());
            this.var_1150 = null;
         }
         ...
         if(this.var_762)
         {
            this.var_762.release(new IIDSessionDataManager());
            this.var_762 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1816 = new OpenedToWebPopup(this);
         }
         this.var_1816.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         this.var_161.events.dispatchEvent(_loc1_);
      }
      
      public function method_1(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         var _loc7_:BitmapData = this.getButtonImage(param2);
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_291,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1150.createAvatarImage(param1,AvatarScaleType.const_92,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_186.getKey("client.minimail.embed.enabled");
         return _loc1_ == "HabboWindowManagerCom_habbo_skin_button_default_white_xml";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_186.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_161 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_100.addCategory(new FriendCategory(FriendCategory.const_1038,this.getText("friendlist.friends")));
         ...
         this.var_161.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.FRIENDLIST));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_431.findTab(FriendListTab.const_97).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_431.findTab(FriendListTab.const_97);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1817.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_431.findTab(FriendListTab.const_97);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_762 || !this.var_351)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_762.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_46))
         {
            _loc2_ = this.var_351.vipLimit;
         }
         else if(this.var_762.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_176) as IBitmapWrapperWindow;
