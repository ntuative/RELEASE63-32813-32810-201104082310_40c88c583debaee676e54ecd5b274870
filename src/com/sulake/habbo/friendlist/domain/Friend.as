package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1861:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_702 = param1.online;
         this.var_1830 = param1.followingAllowed && param1.online;
         this.var_599 = param1.figure;
         this.var_1726 = param1.motto;
         this.var_1619 = param1.lastAccess;
         this.var_1397 = param1.categoryId;
         this.var_1620 = param1.realName;
