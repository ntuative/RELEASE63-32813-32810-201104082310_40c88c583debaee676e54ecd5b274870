package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1804:String = "no_reqs_info";
      ...
      private var var_2006:IContainerButtonWindow;
      
      private var var_2007:IContainerButtonWindow;
      ...
      {
         this.var_2006 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2007 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2007.procedure = this.onDismissAllButtonClick;
         this.var_2006.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_372)
         {
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_372;
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_409 && _loc4_.state != FriendRequest.const_372)
            {
               _loc4_.state = FriendRequest.const_372;
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2006,_loc1_);
         this.setEnabled(this.var_2007,_loc1_);
      }
