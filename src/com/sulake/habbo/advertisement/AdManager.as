package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1104:BitmapData = null;
      
      private var var_1103:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2240 = this._config.getKey("interstitial.enabled","false") == "HabboWindowManagerCom_habbo_skin_button_default_white_xml";
         this.var_2241 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2243 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1684 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_216 != null && this.var_216.running)
         {
            this.var_216.reset();
            return false;
         }
         if(this.var_1105 == 0)
         {
            this.var_1105 = getTimer();
            return false;
         }
         if(this.var_1684 > 0 && this.var_1683 >= this.var_1684)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1105;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1376 = _loc2_.imageUrl;
         this.var_2242 = _loc2_.clickUrl;
         this.var_1105 = getTimer();
         if(this.var_1376 != "")
         {
            ...
            {
               this.var_216 = new Timer(this.var_2243,1);
               this.var_216.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_216.running)
            {
               this.var_216.reset();
            }
            this.var_216.start();
            _loc4_ = new URLRequest(this.var_1376);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_474,0,0,param1.bitmapData,this.var_2242));
            this.var_1105 = getTimer();
         }
         else
         {
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1375 = _loc2_.imageUrl;
         this.var_1682 = _loc2_.clickUrl;
         if(this.var_1375 != "" && this.var_1682 != "")
         {
            ...
            _loc4_ = new URLRequest(this.var_1375);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_496,0,0,_loc4_,_loc2_.assetName,this.var_1682,this.var_1104,this.var_1103));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1104 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1103 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function loadImageAsset(param1:AdImageEvent) : void
      {
         ...
         var _loc3_:Array = this.var_587.getValue(_loc2_);
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_587.add(_loc2_,_loc3_);
         }
         if(_loc3_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_587.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:AdImageEvent) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_888,param2.roomId,0,param1.clone(),param2.imageUrl,param2.clickUrl,null,null,param2.objectId));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_779,_loc5_.roomId,0,null,_loc5_.imageUrl,_loc5_.clickUrl,null,null,_loc5_.objectId));
         }
      }
   }
}
