package com.sulake.habbo.navigator
{
   ...
   public class GuestRoomDoorbell
   {
      ...
      private var var_1155:GuestRoomData;
      ...
      {
         this.show(this.var_1155,null,true);
      }
      ...
      private function createWindow() : void
      {
         ...
         var _loc3_:IWindow = this._window.findChildByName("cancel_region") as IWindow;
         if(_loc3_ != null)
         {
      ...
      {
         this._navigator.goToRoom(this.var_1155.flatId,true);
         this.hide();
      }
