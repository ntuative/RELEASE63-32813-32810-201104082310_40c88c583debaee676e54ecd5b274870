package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_660 = new Timer(100);
         this.var_660.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_660)
         {
            this.var_660.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_660.reset();
            this.var_660 = null;
         }
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_60 = IItemListWindow(this.var_187.findChildByName("item_list"));
         ...
         this.var_1258 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_187.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1258.goBackToInitialState();
         this.var_1258.input.textBackgroundColor = 4294967295;
         this.var_1257 = this.var_44[0];
         this.refreshRoomThumbnails();
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         var _loc6_:IBitmapWrapperWindow = this._navigator.method_1(param2.name,"model_" + param2.name,null,0,0,0);
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_65,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1258.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1258.getText();
