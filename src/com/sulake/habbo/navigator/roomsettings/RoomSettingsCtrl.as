package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_948:TextFieldManager;
      ...
      private var var_641:ICheckBoxWindow;
      
      private var var_1918:IWindowContainer;
      
      private var var_1510:IWindowContainer;
      
      private var var_1217:IWindowContainer;
      ...
      private var var_2632:ITextWindow;
      ...
      {
         if(param1 != this.var_374 || this.var_1210 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1210 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1487)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1715)
         {
            this.setTagError(this.var_948,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_947,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1510)
         {
            this.setTagError(this.var_948,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_947,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1554)
         {
      ...
      private function clearErrors() : void
      {
         ...
         this.var_948.clearErrors();
         this.var_947.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_808 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1214 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_948 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_947 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_999 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1218 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         ...
         this.var_1211 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_641 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1918 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1510 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1217 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         ...
         this.var_1509 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_262 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1212 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2633 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2632 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1508 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1508.mouseThreshold = 0;
         this.var_1508.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1212.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1918.visible = this._inRoom;
         this._switchViewContainer.visible = this._inRoom;
         this.var_2632.visible = this.var_533;
         this.var_2633.visible = !this.var_533;
         if(this.var_533)
         {
         ...
         {
            this.populateForm();
            this.var_1217.visible = true;
            this.var_1509.visible = true;
            this.var_1510.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1510.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1217.height = Util.getLowestPoint(this.var_1217) + 4;
         }
         this.var_1508.text = !!this.var_533 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1918.name,this.var_1510.name,this.var_1217.name,this.var_1216.name,this.var_1509.name,this._switchViewContainer.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.setTag(this.var_948,_loc1_.tags[0]);
         this.setTag(this.var_947,_loc1_.tags[1]);
         if(this.var_1215)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_641)
         {
            ...
            {
               this.var_641.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_641.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_808.getText();
         ...
         _loc2_.allowWalkThrough = this.var_1211.isSelected;
         _loc2_.hideWalls = this.var_641.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_948,_loc2_.tags);
         this.addTag(this.var_947,_loc2_.tags);
         this.clearErrors();
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_171,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_65,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,100,20)));
      }
