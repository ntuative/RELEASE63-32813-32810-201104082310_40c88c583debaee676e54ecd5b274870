package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1399:int = 8;
      
      private static const const_1398:int = -16;
      
      private static const const_1397:int = 40;
      ...
      private var var_997:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         this.var_997 = new ThumbnailImageConfigurations(this._navigator);
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_1002 + _loc3_,param2 * const_1399);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_291,HabboWindowStyle.const_44,0 | (!!param3 ? HabboWindowParam.const_41 : HabboWindowParam.const_44),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_997.getImage(ThumbnailEditorModel.const_40,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_997.getImage(ThumbnailEditorModel.const_40,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_997.getImage(ThumbnailEditorModel.const_63,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_997.getImage(ThumbnailEditorModel.const_35,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1398,_loc4_.y + const_1397 - _loc5_.height),null,null,true);
      }
