package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2624:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1906 = IButtonWindow(this.find("bg_tab"));
         this.var_1907 = IButtonWindow(this.find("top_tab"));
         this.var_1905 = IButtonWindow(this.find("obj_tab"));
         this.var_2624 = IWindowContainer(this.find("tile_grid"));
         ...
         Util.setProcDirectly(this.var_1906,this.onBgTabButton);
         Util.setProcDirectly(this.var_1907,this.onTopTabButton);
         Util.setProcDirectly(this.var_1905,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1906,this.var_66.mode != ThumbnailEditorModel.const_40);
         this.setEnabled(this.var_1907,this.var_66.mode != ThumbnailEditorModel.const_63);
         this.setEnabled(this.var_1905,this.var_66.mode != ThumbnailEditorModel.const_35);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2624;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_482)
            {
               _loc4_ = this._navigator.method_1("pos_" + _loc3_,"rico_tile",this.onSelectPos,0,0,_loc3_);
               this.refreshTileLoc(_loc4_,_loc3_);
               _loc1_.addChild(_loc4_);
               _loc5_ = this._navigator.method_1("block_" + _loc3_,"rico_tile_x",this.onSelectPos,0,0,_loc3_);
               _loc5_.visible = false;
               this.refreshTileLoc(_loc5_,_loc3_);
               _loc1_.addChild(_loc5_);
               _loc3_++;
            }
            _loc1_.addChild(this._navigator.method_1("selected","rico_tile_s",null,0,0));
         }
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_65,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_452,HabboWindowStyle.const_44,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_291,HabboWindowStyle.const_44,HabboWindowParam.const_62,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
