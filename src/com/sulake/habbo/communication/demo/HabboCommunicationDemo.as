package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_534:IKeyExchange;
      
      private var var_1000:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2637:PseudoRandom;
      ...
      private var var_226:HabboHotelView;
      
      private var var_1513:String = "";
      
      private const const_1784:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_642 = param1;
            this.var_57.initConnection(HabboConnectionType.const_269);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionEvent.const_90,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_226 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_226.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_163.getKey("use.sso.ticket") == "1";
         this.var_642 = this.var_163.getKey("sso.ticket",null);
         this.var_1921 = this.var_163.getKey("flash.client.url","");
         this.var_2636 = this.var_163.getKey("external.variables.txt","");
         if(this.var_226 == null)
         {
            this.var_226 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_57.mode = HabboConnectionType.const_1081;
            }
         }
         this.var_57.initConnection(HabboConnectionType.const_269);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_854);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2637 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_57.mode)
         {
            case HabboConnectionType.const_94:
               ...
               this.var_226.loadBannerImage(_loc7_ + "?token=" + this.var_1513,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1081:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1743:
               this.var_1000 = this.generateRandomHexString(30);
               this.var_534 = new DiffieHellman(new BigInteger(this.var_163.getKey("connection.development.prime"),16),new BigInteger(this.var_163.getKey("connection.development.generator"),16));
               this.var_534.init(this.var_1000);
               _loc8_ = this.var_534.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_534.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_534.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2637);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1921,this.var_2636));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1784,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_642 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_642);
            _loc2_.send(_loc4_);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_243);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2635)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1513);
         ...
         this.var_534 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_534.init(_loc14_);
            _loc15_ = this.var_534.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1000 = _loc14_;
            }
