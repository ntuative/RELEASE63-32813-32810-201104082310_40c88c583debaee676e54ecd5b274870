package com.sulake.habbo.quest
{
   ...
   public class PendingFurniImage implements IGetImageListener, IDisposable
   {
      ...
      public function PendingFurniImage(param1:HabboQuestEngine, param2:IBitmapWrapperWindow, param3:IFurnitureData, param4:int)
      {
         ...
         this.var_86 = param1;
         this.var_661 = param2;
         var _loc5_:ImageResult = this.var_86.roomEngine.getFurnitureImage(param3.id,new Vector3d(90,0,0),64,this,param4,"");
         this.var_2572 = _loc5_.id;
      ...
      {
         if(this.var_2572 == param1)
         {
            QuestUtils.setElementImage(this.var_661,param2,this.var_661.height);
            this.dispose();
         }
      }
   }
