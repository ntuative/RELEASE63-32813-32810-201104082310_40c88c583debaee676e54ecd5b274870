package com.sulake.habbo.quest
{
   ...
   public class IncomingMessages implements IDisposable
   {
      ...
      private var var_1857:IAlertDialog;
      ...
      public function IncomingMessages(param1:HabboQuestEngine)
      {
         super();
         this.var_86 = param1;
         this._communication = this.var_86.communication;
      ...
      private function onQuestCompleted(param1:IMessageEvent) : void
      {
         ...
         new QuestCompleted(this.var_86,_loc2_.questData);
      }
      ...
      private function onQuests(param1:IMessageEvent) : void
      {
         ...
         this.var_86.controller.onQuests(_loc2_.quests,_loc2_.openWindow);
      }
      ...
      private function onQuest(param1:IMessageEvent) : void
      {
         ...
         this.var_86.controller.onQuest(_loc2_.quest);
      }
      ...
      private function getCampaignCode() : String
      {
         ...
         var _loc2_:String = this.var_86.configuration.getKey("questing.defaultCampaign.override","");
         var _loc3_:String = this.var_86.configuration.getKey("questing.excludedCampaignCode","");
      ...
      {
         this.var_86.controller.onRoomEnter();
         this.var_86.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.QUESTS));
      }
      
      private function onRoomExit(param1:IMessageEvent) : void
      {
         this.var_86.controller.onRoomExit();
         this.var_86.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_171,HabboToolbarIconEnum.QUESTS));
      }
   }
}
