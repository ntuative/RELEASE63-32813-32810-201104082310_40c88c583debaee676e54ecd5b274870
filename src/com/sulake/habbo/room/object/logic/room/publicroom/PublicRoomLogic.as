package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_197,RoomObjectRoomAdEvent.const_340,RoomObjectRoomAdEvent.const_289];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_736,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_502,Number(false));
         this.var_852 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1174:
                  _loc2_.setString(RoomObjectVariableEnum.const_389,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_736,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_502,Number(true));
                  this.var_1483 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1165);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_502,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_736);
