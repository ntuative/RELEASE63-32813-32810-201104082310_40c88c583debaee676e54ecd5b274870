package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1372:uint = 16777215;
      
      private var var_1669:int = 255;
      
      private var var_1097:uint = 16777215;
      
      private var var_1666:int = 255;
      
      private var var_1096:int = 0;
      
      private var var_1668:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_495,RoomObjectMouseEvent.const_128];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(!this._planeParser.method_5(param1))
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1242,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_855,16777215);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1096)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1667;
            if(_loc2_ - this.var_1096 >= this.var_1668)
            {
               _loc3_ = this.var_1097;
               _loc4_ = this.var_1666;
               this.var_1096 = 0;
            }
            else
            {
               _loc7_ = this.var_1372 >> 16 & 255;
               _loc8_ = this.var_1372 >> 8 & 255;
               _loc9_ = this.var_1372 & 255;
               _loc10_ = this.var_1097 >> 16 & 255;
               _loc11_ = this.var_1097 >> 8 & 255;
               _loc12_ = this.var_1097 & 255;
               _loc13_ = (_loc2_ - this.var_1096) / this.var_1668;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1669 + (this.var_1666 - this.var_1669) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_855,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_721:
               param2.setString(RoomObjectVariableEnum.const_326,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_772:
               param2.setString(RoomObjectVariableEnum.const_310,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_480:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_257)
               {
                  _loc5_ = "null";
               }
               this.var_552.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_650:
               _loc4_ = this.var_552.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_552.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1137,_loc7_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1050,int(param1.bgOnly));
         this.var_1372 = this._color;
         this.var_1669 = this.var_1667;
         this.var_1097 = _loc3_;
         this.var_1666 = _loc4_;
         this.var_1096 = getTimer();
         this.var_1668 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_560,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1741,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1714,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1566,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_560,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_167 || _loc12_ == RoomPlaneData.const_303)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
