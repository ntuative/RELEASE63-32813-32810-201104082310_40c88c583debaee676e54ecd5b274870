   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2529)
         {
            ...
            if(param1 is RoomObjectAvatarUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_190,_loc4_.dirHead);
               return;
            }
            ...
            if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_139,_loc6_.gesture);
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_692,Number(_loc9_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1540,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_868,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.CLICK:
               ...
               if(eventDispatcher != null)
               {
                  _loc8_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_128,param1.eventId,_loc6_,_loc7_,param1.altKey,param1.ctrlKey,param1.shiftKey,param1.buttonDown);
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_190,_loc3_ + this.var_967);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1865;
            _loc2_.setNumber(RoomObjectVariableEnum.const_254,this.var_1865);
            _loc2_.setNumber(RoomObjectVariableEnum.const_139,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1866;
            _loc2_.setNumber(RoomObjectVariableEnum.const_139,this.var_1866);
         }
         else
         {
            this.var_967 += 45;
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         ...
         {
            param2.setString(RoomObjectVariableEnum.const_139,null);
            this.var_1474 = 0;
         }
         if(this.var_1471 > 0)
         {
