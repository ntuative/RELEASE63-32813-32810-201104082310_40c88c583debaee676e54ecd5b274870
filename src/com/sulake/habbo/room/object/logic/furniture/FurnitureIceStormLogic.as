package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private var var_2707:Number = 0.0;
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_1780 = _loc2_;
            this.var_2707 = param1.extra;
            this.var_1229 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1229 > 0 && param1 >= this.var_1229)
         {
            this.var_1229 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1780,String(this.var_1780),this.var_2707);
