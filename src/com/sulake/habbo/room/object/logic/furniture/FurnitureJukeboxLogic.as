package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_540,RoomObjectFurnitureActionEvent.const_604,RoomObjectFurnitureActionEvent.const_527,RoomObjectFurnitureActionEvent.const_455,RoomObjectWidgetRequestEvent.const_142];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_559,RoomWidgetInfostandExtraParamEnum.const_823);
            ...
            if(_loc4_ != this.var_2416)
            {
               this.var_2416 = _loc4_;
               if(_loc4_ == 1)
               {
