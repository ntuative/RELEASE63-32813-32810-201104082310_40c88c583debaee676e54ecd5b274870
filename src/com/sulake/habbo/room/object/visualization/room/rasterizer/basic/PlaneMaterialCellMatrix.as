package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_278:int = 5;
      
      public static const const_903:int = 6;
      
      public static const const_1614:int = const_396;
      ...
      private var var_2259:Number = -1.0;
      
      private var _normalMaxX:Number = 1.0;
      
      private var var_2258:Number = -1.0;
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this._cachedBitmapNormal,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_630,param6,param7);
                     return param1;
                  }
                  return this.var_30;
               }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_630);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_630,this.var_30.width,this.var_630);
         }
