package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1568:int = 13421772;
      
      private static const const_1027:int = 16777215;
      
      private static const const_1029:int = 13421772;
      
      private static const const_1026:int = 10066329;
      
      private static const const_1028:int = 10066329;
      
      public static const const_1500:int = 16777215;
      
      public static const const_1559:int = 13421772;
      
      public static const const_1737:int = 10066329;
      ...
      private var var_835:Rectangle = null;
      
      private var var_552:RoomPlaneBitmapMaskParser = null;
      
      private var var_1497:String = null;
      ...
      private var var_1279:uint = 16777215;
      
      private var var_2810:int = 255;
      ...
      private const const_2076:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_552 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_835 = super.boundingRectangle;
         }
         return new Rectangle(this.var_835.x,this.var_835.y,this.var_835.width,this.var_835.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1242);
         if(!this._planeParser.method_5(new XML(_loc2_)))
         {
            return;
         }
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1079);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1478)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_120,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1687 + this.const_2076 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_388.length)
            {
               _loc11_ = this.var_675[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_388[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2025)
                  {
                     ...
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2810 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1854)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1536 || _loc3_.y != this.var_2730 || _loc3_.z != this.var_2731 || param1.scale != this.var_2729))
            {
               this.var_1536 = _loc3_.x;
               this.var_2730 = _loc3_.y;
               this.var_2731 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1137);
            if(_loc3_ != this.var_2808)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2808 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_855));
            if(_loc4_ != this.var_1279)
            {
               this.var_1279 = _loc4_;
               this.var_2809 = this.var_1279 & 255;
               this.var_2807 = this.var_1279 >> 8 & 255;
               this.var_2810 = this.var_1279 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1050));
            if(_loc5_ != this.var_2025)
            {
               this.var_2025 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_171 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_310);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_326);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_305);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_711));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_696));
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_388;
         if(this.var_388.length == 0)
         {
            _loc6_ = this.var_128;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_388.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_388.push(_loc12_);
                        this.var_675.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1987;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_552.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_552.maskCount)
         {
            _loc10_ = this.var_552.getMaskType(_loc8_);
            _loc11_ = this.var_552.getMaskLocation(_loc8_);
            _loc12_ = this.var_552.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_120 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_257)
                              {
