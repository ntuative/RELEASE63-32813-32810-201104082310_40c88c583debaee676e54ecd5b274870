package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1656:int = 0;
      ...
      private var var_786:PlaneMaskManager = null;
      ...
      {
         return this._isVisible && this.var_796;
      }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_796 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_365))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_315.length * param1.scale;
            _loc6_ = this.var_314.length * param1.scale;
            ...
            if(this.var_983 != null)
            {
               _loc3_ = this.var_983.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1879,this.var_2554,this.var_2551,this.var_2552,this.var_2555,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1854 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_796)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1466.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1466[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1197);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_159.z - originZ,this.var_116.z - originZ,this.var_85.z - originZ,this.var_115.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2550 = relativeDepth;
            this._isVisible = true;
            this.var_1854 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2553);
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_982)
         {
            ...
            {
               _loc4_ = this.var_260[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_260.length == this.var_981.length)
         {
            while(_loc1_ < this.var_260.length)
            {
               _loc4_ = this.var_260[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
         ...
         if(this.var_366.length > this.var_1481.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_982 || this.var_260.length == 0 && this.var_366.length == 0 && !this.var_365 || this.var_786 == null)
         {
            return;
         }
         ...
         if(this.var_365)
         {
            ...
            while(_loc5_ < this.var_260.length)
            {
               _loc3_ = this.var_260[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc3_.leftSideLoc / this.var_315.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc3_.rightSideLoc / this.var_314.length;
                  _loc12_ = _loc3_.type;
                  this.var_786.updateMask(this.var_68,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_366.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc4_.leftSideLoc / this.var_315.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc4_.rightSideLoc / this.var_314.length;
                  _loc13_ = this.var_68.width * _loc4_.leftSideLength / this.var_315.length;
                  _loc14_ = this.var_68.height * _loc4_.rightSideLength / this.var_314.length;
                  this.var_68.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1481.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_365 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_224.copyChannel(param1,param1.rect,const_636,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_224.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_224,this.var_224.rect,const_636,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
