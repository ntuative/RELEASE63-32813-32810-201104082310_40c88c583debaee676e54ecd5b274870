package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1393:String = "head";
      
      private static const const_637:int = 1;
      
      private static const const_1000:int = 1000;
      
      private static const const_1391:String = "pet_experience_bubble_png";
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1391) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2571)
            {
               this.var_2571 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_254);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_139);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_254);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_139);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1802 = _loc3_.getNumber(RoomObjectVariableEnum.const_414) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_190);
            if(!isNaN(_loc8_))
            {
            ...
            {
               this.var_1890 = direction;
            }
            this.var_1408 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2348 = _loc3_.getNumber(RoomObjectVariableEnum.const_692);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_868);
            if(_loc9_ != this.var_1891)
            {
               this.var_1891 = _loc9_;
               this.var_2570 = this.var_1891.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_367 != null)
         {
            ...
            if(this.var_1408 > 0)
            {
               _loc2_ = param1 - this.var_1408;
               if(_loc2_ < const_1000)
               {
                  this.var_367.alpha = int(Math.sin(_loc2_ / const_1000 * 0) * 255);
      ...
      {
         return super.getAdditionalSpriteCount() + const_637;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2570);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_637)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_637))
            {
               if(param2 >= FurnitureVisualizationData.const_446.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_446[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1890);
         }
         return direction;
      }
      ...
      {
         if(this.var_985[param1] == null)
         {
            if(this._animationData.getTag(var_88,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1393)
            {
               this.var_985[param1] = true;
            }
            else
            {
               this.var_985[param1] = false;
            }
         }
