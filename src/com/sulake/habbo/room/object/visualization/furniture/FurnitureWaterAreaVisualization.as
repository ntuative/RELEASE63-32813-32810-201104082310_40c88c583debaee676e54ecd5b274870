package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      {
         if(this.var_2631 == param1 && this.var_2630 == direction)
         {
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1206.indexOf(_loc2_) < 0)
            {
               this.var_1206.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_531 == 0 || this.var_638 == 0)
         {
            ...
            this.var_531 = _loc2_.getNumber(RoomObjectVariableEnum.const_333);
            this.var_638 = _loc2_.getNumber(RoomObjectVariableEnum.const_412);
         }
         this.var_442 = [];
         this.var_639 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_531 * 2 + this.var_638 * 2)
         {
            this.var_442.push(false);
            this.var_639.push(ShoreMaskCreatorUtility.const_78);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_68,getSize(param3),this.var_442,this.var_639,assetCollection);
      }
