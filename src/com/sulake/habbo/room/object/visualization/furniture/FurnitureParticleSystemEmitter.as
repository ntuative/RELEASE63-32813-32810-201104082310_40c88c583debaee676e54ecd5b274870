package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1480:String = "cone";
      
      public static const const_1653:String = "plane";
      
      public static const const_1588:String = "sphere";
      ...
      private var var_928:Number = 0.1;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_347)
         {
            _loc1_.dispose();
         }
         this.var_347 = null;
      ...
      public function reset() : void
      {
         ...
         this.var_927 = 0;
         this.var_938 = false;
         this.init(0,0,0,this._direction,this.var_2388,this.var_928,this.var_2389,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1138.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_938 = true;
         if(this.var_927 < this.var_1418)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         while(_loc10_ < this.var_2386)
         {
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_928,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1138.length);
         return this.var_1138[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_927 < this.var_1418)
         {
            if(this.age % this.var_2391 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_927 < this.var_1418)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_249) * this.x - (1 - this.var_249) * this.lastX;
            this.y = (2 - this.var_249) * this.y - (1 - this.var_249) * this.lastY + this.var_1783 * this.var_928 * this.var_928;
            this.z = (2 - this.var_249) * this.z - (1 - this.var_249) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_347)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_249) * _loc2_.x - (1 - this.var_249) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_249) * _loc2_.y - (1 - this.var_249) * _loc2_.lastY + this.var_1783 * this.var_928 * this.var_928;
            _loc2_.z = (2 - this.var_249) * _loc2_.z - (1 - this.var_249) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_347.splice(this.var_347.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
