   ...
   public class FurnitureBillboardVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            {
               _loc5_ = _loc4_.getString(RoomObjectVariableEnum.const_752);
               if(_loc5_ != null)
               {
                  _loc6_ = _loc4_.getString(RoomObjectVariableEnum.const_605);
                  if(_loc6_ == "HabboWindowManagerCom_habbo_skin_button_default_white_xml")
                  {
