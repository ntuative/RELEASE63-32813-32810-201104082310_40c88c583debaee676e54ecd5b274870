package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1157:Number = 1.0;
      ...
      private var var_1819:Matrix;
      
      private var _translationMatrix:Matrix;
      
      private var var_738:Number = 1.0;
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_97 = this.var_1156[param1];
         this.var_938 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1820 >= 0)
         {
            this.var_252 = this._visualization.getSprite(this.var_1820);
            if(this.var_252 && this.var_252.asset)
            {
               ...
               if(this.var_83 == null)
               {
                  ...
                  {
                     this.var_610 = new BitmapData(this.var_83.width,this.var_83.height,true,4278190080);
                  }
               }
               this.var_2274 = -this.var_252.offsetX;
               this.var_2275 = -this.var_252.offsetY;
            ...
            if(this.var_610)
            {
               this.var_610.fillRect(this.var_610.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_97.y * this.var_1157;
         }
         return 0;
      }
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_938 && this.var_97.hasIgnited)
         {
            this.var_938 = true;
         }
         _loc8_ = this.var_1098 * this.var_1157;
         this.var_97.update();
         if(this.var_938)
         {
            if(this.var_97.roomObjectSpriteId >= 0)
            ...
            {
               this.var_83.draw(this.var_610,this.var_1819,this.var_764,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_97.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2274 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1157;
               _loc4_ = this.var_2275 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1157;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_83.draw(_loc7_,this._translationMatrix,this.var_1441,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2459 = parseInt(param1.@size);
         this.var_1820 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1098 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1157 = this.var_2459 / 64;
         this.var_738 = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this.var_738 = Math.min(this.var_738,1);
         this.var_764.alphaMultiplier = this.var_738;
         for each(_loc3_ in param1.emitter)
         {
            ...
            for each(_loc23_ in _loc3_.particles.particle)
            {
               ...
               _loc20_ = _loc23_.hasOwnProperty("@fade") && _loc23_.@fade == "HabboWindowManagerCom_habbo_skin_button_default_white_xml" ? true : false;
               _loc21_ = [];
