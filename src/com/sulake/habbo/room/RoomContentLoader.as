package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_824:String = "RCL_LOADER_READY";
      
      private static const const_351:String = "RCL_PUBLICROOM_";
      
      private static const const_1783:int = 0;
      
      private static const const_996:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_439:String = "place_holder";
      
      private static const const_633:String = "wall_place_holder";
      
      private static const const_635:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_439;
      
      private static const const_634:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_997:String = "selection_arrow";
      ...
      public function RoomContentLoader()
      {
         ...
         this.var_2531 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2534 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2530 = param2.getKey("public.room.dynamic.download.url","");
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_791.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_429.add(_loc3_,_loc4_);
      ...
      private function continueInitilization() : void
      {
         if(this.var_2532)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_824));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_522 != null)
         {
            this.var_522.remove(param2);
            this.var_522.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_522 != null)
         {
            _loc2_ = this.var_522.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         return [const_439,const_633,const_635,const_634,TILE_CURSOR,const_997];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_429.getValue(param1) as String;
      ...
      {
         var _loc3_:Map = this.var_968[param1];
         if(_loc3_ != null)
         {
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_791.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_200 != null && this.var_200.hasWorldType(const_351 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_242 || param1 == RoomObjectVisualizationEnum.const_70 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2530 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1477.getValue(param1) != null)
         {
            this.var_200 = this.var_1477.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_894,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2531.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1710);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_428[_loc5_] != null)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_521,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_428[param1];
            this.var_968.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1477.add(param1,_loc4_);
         this.var_200 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_790.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_790.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = this.var_790.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_526.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_351 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_351 + param1) == RoomObjectCategoryEnum.const_77)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_200.getWorldHeightScale(const_351 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_200 != null)
         {
            return this.var_200.getWorldScale(const_351 + param1);
         }
         return 32;
      }
      ...
      {
         this.var_429.remove(param1);
         this.var_429.add(param1,param2);
      }
   }
}
