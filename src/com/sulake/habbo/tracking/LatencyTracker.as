package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         if(this.var_186 == null || this._communication == null || this._connection == null)
         {
            return;
         }
         this.var_1911 = int(this.var_186.getKey("latencytest.interval"));
         this.var_1910 = int(this.var_186.getKey("latencytest.report.index"));
         this.var_2625 = int(this.var_186.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1909 > this.var_1911)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_636.add(this.var_1505,this.var_1909);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1505));
         ++this.var_1505;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_636 == null || this.var_225 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_636.getValue(_loc2_.requestId);
         this.var_636.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_225.push(_loc4_);
         if(this.var_225.length == this.var_1910 && this.var_1910 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1912) > this.var_2625 || this.var_1912 == 0)
            {
               this.var_1912 = _loc9_;
