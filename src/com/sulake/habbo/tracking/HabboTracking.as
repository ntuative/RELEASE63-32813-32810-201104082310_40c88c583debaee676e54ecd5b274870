package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1016:uint = 11;
      ...
      private var var_1247:IHabboWindowManager;
      ...
      private var var_454:FramerateTracker = null;
      
      private var var_271:LatencyTracker = null;
      
      private var var_656:LagWarningLogger = null;
      
      private var var_657:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_454 = new FramerateTracker();
         this.var_271 = new LatencyTracker();
         this.var_656 = new LagWarningLogger();
         this.var_657 = new ToolbarClickTracker(this);
         this.var_1547 = new Array(const_1016);
         var _loc4_:int = 0;
         while(_loc4_ < const_1016)
         {
            this.var_1547[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1742,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1692,Capabilities.serverString);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1247)
            {
               this.var_1247.release(new IIDHabboWindowManager());
               this.var_1247 = null;
            }
            if(this.var_319)
            {
            ...
            if(this.var_208)
            {
               if(!this.var_208.disposed)
               {
                  ...
                  Component(this.var_208).events.removeEventListener(HabboFriendListTrackingEvent.const_375,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_137)
            {
               if(!this.var_137.disposed)
               {
                  this.var_137.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_137.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_137.release(new IIDHabboHelp());
               this.var_137 = null;
            }
            if(this.var_161)
            {
               ...
               {
                  this.var_161.events.removeEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
               }
      ...
      {
         this.var_1547[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_186 = IHabboConfigurationManager(param2);
         if(this.var_186)
         {
            if(this.var_271 != null)
            {
               this.var_271.configuration = this.var_186;
            }
            if(this.var_272 != null)
            {
               this.var_272.configuration = this.var_186;
            }
            ...
            if(this.var_186)
            {
               ...
               {
                  this.var_656.configure(this.var_186);
               }
               if(this.var_454 != null)
               {
                  this.var_454.configure(this.var_186);
               }
               if(this.var_657 != null)
               {
                  this.var_657.configure(this.var_186);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_854,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_697,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_66,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_478,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_656 != null)
            {
               this.var_656.connection = param1;
            }
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1730);
               break;
            case HabboCommunicationEvent.const_854:
               this.trackLoginStep(HabboLoginTrackingStep.const_1698,String(this._communication.port));
               break;
      ...
      {
         this.var_1247 = IHabboWindowManager(param2);
         if(this.var_1247)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_186)
            {
               if(this.var_186.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_186.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1547)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1125);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1125,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_208).events.addEventListener(HabboFriendListTrackingEvent.const_375,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_137 = param2 as IHabboHelp;
         this.var_137.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_137.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_319.events.addEventListener(AdEvent.const_496,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_161 = param2 as IHabboToolbar;
         this.var_161.events.addEventListener(HabboToolbarEvent.const_37,this.onToolbarClick);
      }
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_454)
               {
                  ...
                  this._connection.send(new ConversionPointMessageComposer("Performance","fps",String(this.var_454.frameRate),_loc2_));
                  ++this.var_1966;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_657)
         {
            this.var_657.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_186 != null && !Boolean(this.var_186.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_656.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_542 > -1 && _loc2_ < this.var_542)
         {
            ++this.var_1964;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1964);
         }
         if(this.var_542 > -1 && _loc2_ - this.var_542 > 15000)
         {
            ++this.var_1965;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1965);
         }
         this.var_542 = _loc2_;
         if(this.var_272 != null)
         {
            this.var_272.update(param1,this.var_542);
         }
         if(this.var_271 != null)
         {
            this.var_271.update(param1,this.var_542);
         }
         if(this.var_454 != null)
         {
            this.var_454.trackUpdate(param1,this,this.var_542);
         }
         if(this.var_656 != null)
         {
            this.var_656.update(this.var_542);
         }
      }
   }
}
