package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      public static const const_572:int = 2;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_41 = param3;
         this.var_2318 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         ...
         this.var_1719 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1720 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2317 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2319 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_74 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_291,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,param3.width,param3.height - const_83),null,0,0) as IBitmapWrapperWindow;
         this.var_41.addChild(this.var_74);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_65,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_41.height - const_83,param3.width,const_83),null,0) as IWindowContainer;
         this.var_41.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_452,HabboWindowStyle.const_44,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_83),null,0) as IRegionWindow;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_41.height - const_83;
            this._window.width = this.var_41.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_41.height - const_83;
            this._region.width = this.var_41.width - this.var_2321;
         }
         if(this.var_74 != null)
         {
            this.var_74.rectangle = this.var_41.rectangle;
            this.var_74.height -= const_83;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2320 == this._window.width)
         {
            return;
         }
         this.var_2320 = this._window.width;
         ...
         if(_loc2_ != null && _loc5_ != null)
         {
            ...
            _loc2_.bitmap = this.var_1719;
            _loc2_.disposesBitmap = false;
            this.var_2321 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2318,_loc7_);
         ...
         this.var_74.bitmap = this.var_2319;
