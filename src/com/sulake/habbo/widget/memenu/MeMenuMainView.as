package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_169)
         {
            _loc6_ = this.var_169[_loc3_];
         ...
         while(_loc5_ < this._window.numChildren)
         {
            ...
            _loc4_.addEventListener(WindowMouseEvent.const_28,this.onMouseOverOrOut);
            _loc5_++;
         }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "wave":
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1076));
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_735);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_1149));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_323);
               break;
            case "hc":
               ...
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_860);
               break;
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","false") == "HabboWindowManagerCom_habbo_skin_button_default_white_xml";
               if(false && _loc4_)
               {
