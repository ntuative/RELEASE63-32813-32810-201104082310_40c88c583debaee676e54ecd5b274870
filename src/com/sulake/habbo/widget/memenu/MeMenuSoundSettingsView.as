package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_960:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_512 = param1.volume;
         if(this.var_960 != null)
         {
            this.var_960.setValue(this.var_512);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_960 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowMouseEvent.const_28,this.onButtonOut);
         }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_512 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1850);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1848);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_847);
         }
