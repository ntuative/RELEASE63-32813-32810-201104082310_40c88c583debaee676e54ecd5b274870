package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView extends InfoStandFurniView
   {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_238 = var_53.findChildByTag("catalog");
         if(var_238 != null)
         {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_401)
         {
            this.var_1674 = param1.songId;
         }
         if(param1.songId == this.var_1674)
         {
            this._songName = param1.songName;
            this.var_2221 = param1.songAuthor;
            this.updateNowPlaying(this.var_1674 >= 0);
         }
      }
      ...
      private function updateNowPlaying(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            ...
            this.nowPlayingAuthorName = this.var_2221;
         }
         else
         {
