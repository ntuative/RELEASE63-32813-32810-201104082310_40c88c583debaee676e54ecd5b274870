package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_1066:String = "PLSV_START_PLAYBACK";
      ...
      {
         if(this.var_45 != const_504)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_407[this.var_45];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_407[const_947];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_407.add(const_504,_loc1_);
