package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListEditorItemListView
   {
      ...
      private var var_156:PlayListEditorItem;
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_550);
            }
            return;
         }
         ...
         if(this.var_1242 >= 0 && this.var_1242 < this._items.length)
         {
            _loc2_ = this._items[this.var_1242] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_550);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1093);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_remove_from_playlist" || _loc3_)
            {
               ...
               this._widget.sendRemoveFromPlayListMessage(this.var_1542);
               this.var_1542 = -1;
            }
            else
            {
               ...
               if(_loc4_ != -1)
               {
                  ...
                  this.var_156 = this._items[_loc4_];
                  this.var_156.select();
