package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1111;
         if(this.var_1111 < this.var_900.length)
         {
            _loc1_ = this.var_900[this.var_1111] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_414)
         {
            ...
            this.var_414 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_414.center();
            this.var_414.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_900[this.var_1111] as Dictionary;
