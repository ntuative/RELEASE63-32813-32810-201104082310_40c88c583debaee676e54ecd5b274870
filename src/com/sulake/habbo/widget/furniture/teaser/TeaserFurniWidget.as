package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1814:int = 0;
      
      private const const_1809:int = 1;
      
      private const const_1810:int = 2;
      
      private const const_1812:int = 3;
      
      private const const_1808:int = 4;
      ...
      private const const_2085:int = 3;
      
      private const const_2084:int = 4;
      
      private const const_2080:int = 5;
      
      private const const_1811:String = "deco_img";
      
      private const const_1813:String = "dialog_bg";
      
      private const const_2083:String = "%campaign%_dialog_bg.png";
      
      private const const_356:String = "%campaign%_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1575 = this.var_163.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1575 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1578.length)
         {
            _loc2_ = this.var_1578.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_163 = null;
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_807:
               ...
               {
                  _loc2_ = this.const_1808;
               }
               this._shareId = null;
               this.var_1577 = param1.itemCategory;
               break;
         ...
         if(this._window && (this.var_1576 != _loc2_ || _loc3_ != this.var_191))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1576)
            {
               ...
               case this.const_1809:
                  ...
                  else if(this.var_399 == this.const_2079)
                  {
                  ...
                  else if(this.var_399 == this.const_2082)
                  {
                  ...
                  else if(this.var_399 == this.const_2085)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_399 == this.const_2084)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_191,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_399 == this.const_2080)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2083.replace("%campaign%",this.var_191);
            this.setDecoImage(_loc5_,this.const_1813);
            _loc2_ = _loc2_.replace("%campaign%",this.var_191);
            this.setDecoImage(_loc2_,this.const_1811);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_906);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1577 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1577 == 1 ? "null" : InventoryCategory.const_147);
            }
         }
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1578.push(new ImageDownloader(this,_assets,this.var_191,this.var_1575,param1,param2));
            return;
         }
