package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_626:String = "welcome_gift_email_unverified";
      
      private const const_990:String = "welcome_gift_email_verified";
      
      private const const_1361:String = "welcome_gift_email_change";
      
      private const const_2062:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         {
            this.setViewState(this.const_626);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_626:
               ...
               this._view.findChildByName("edit_text").visible = this.var_937;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_937);
               break;
            case this.const_990:
            ...
            case this.const_1361:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_937);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1437;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1361);
      }
      ...
      {
         this.setViewState(!!this.var_1151 ? this.const_990 : this.const_626);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1438 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1438));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_565,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_565,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_565:
               this.var_1437 = param1.email;
               this.var_1151 = param1.isVerified;
               this.var_937 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1437 = this.var_1438;
            this.setViewState(this.const_626);
         }
         else
         {
            if(param1.result == this.const_2062)
            {
               this.var_937 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1438);
