package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2903:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2903 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_358:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_62,this.var_163,this.var_2339++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_62,this.var_163,this);
               break;
            case RoomWidgetEnum.const_486:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_62,this.var_163,this._catalog);
               break;
            case RoomWidgetEnum.const_607:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_62,events,this.var_163);
               break;
            ...
            case RoomWidgetEnum.const_484:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_62,this.var_163,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_448:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_62,this.var_163);
               break;
            case RoomWidgetEnum.const_940:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_62,this.var_163);
               break;
            case RoomWidgetEnum.const_116:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_62,this.var_163);
               break;
            ...
            case RoomWidgetEnum.const_544:
               _loc2_ = new PlayListEditorWidget(this._windowManager,this._soundManager,assets,this.var_62,this.var_163,this._catalog);
               break;
